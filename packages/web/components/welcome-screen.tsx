...
import { Download, FileText, FolderTree, Moon, Search, Tag } from 'lucide-react'
    ...
    <div className='flex-1 flex items-center justify-center p-6'>
      <Card className='w-full max-w-3xl'>
        <CardHeader>
          ...
          <CardDescription>
            A modern note-taking application for organizing your thoughts and
            ideas
          </CardDescription>
        </CardHeader>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  Format your notes with headings, lists, tasks, and more
                </p>
              </div>
            </div>
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  Organize notes in nested folders for better structure
                </p>
              </div>
            </div>
            <div className='flex items-start space-x-3'>
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  Add tags to notes for flexible categorization
                </p>
              </div>
            </div>
            <div className='flex items-start space-x-3'>
