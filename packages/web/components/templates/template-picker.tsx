...
import { Search, Star, Clock, Grid, Zap } from 'lucide-react'
...
export function TemplatePicker({ open, onOpenChange, onTemplateSelect, onCreateBlank }: TemplatePickerProps) {
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            ...
            <TabsContent value="popular" className="flex-1 overflow-hidden">
              <div className="h-full overflow-auto">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-2">Most Popular Templates</h3>
                ...
                <TemplateGrid templates={templates} loading={loading} onSelectTemplate={handleSelectTemplate} />
              </div>
            </TabsContent>
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
        <TemplateGrid templates={templates} loading={loading} onSelectTemplate={onSelectTemplate} />
      </div>
    </div>
  )
}
