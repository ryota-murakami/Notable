...
const createDragPreviewElements = (
  ...
  const resolveElement = (node: TElement, index: number) => {
    ...
    if (lastDomNode) {
      const lastEditorDomNode = editor.api.toDOMNode(lastDomNode)

      if (lastEditorDomNode?.parentElement && domNode.parentElement) {
        const lastDomNodeRect =
          lastEditorDomNode.parentElement.getBoundingClientRect()
