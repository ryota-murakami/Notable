  ...
  [5179],
  {
    '../../node_modules/.pnpm/@floating-ui+dom@1.7.2/node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, {
          UE: () => floating_ui_dom_arrow,
          ll: () => autoUpdate,
          rD: () => floating_ui_dom_computePosition,
          UU: () => floating_ui_dom_flip,
          jD: () => floating_ui_dom_hide,
          ER: () => floating_ui_dom_limitShift,
          cY: () => floating_ui_dom_offset,
          BN: () => floating_ui_dom_shift,
          Ej: () => floating_ui_dom_size,
        })
        const sides = ['top', 'right', 'bottom', 'left'],
          floating_ui_utils_min = Math.min,
        ...
        function floating_ui_utils_getSideAxis(placement) {
          return yAxisSides.has(floating_ui_utils_getSide(placement))
            ? 'y'
            : 'x'
        }
        ...
        function getOppositeAxisPlacements(
          ...
          })(floating_ui_utils_getSide(placement), 'start' === direction, rtl)
          return (
            alignment &&
              ((list = list.map((side) => side + '-' + alignment)),
              flipAlignment &&
                (list = list.concat(
                  list.map(floating_ui_utils_getOppositeAlignmentPlacement)
                ))),
            list
          )
        }
        ...
        async function detectOverflow(state, options) {
          ...
          const { x, y, platform, rects, elements, strategy } = state,
            ...
            clippingClientRect = floating_ui_utils_rectToClientRect(
            ...
            elementClientRect = floating_ui_utils_rectToClientRect(
        ...
        function getBoundingClientRect(
          ...
          return floating_ui_utils_rectToClientRect({ width, height, x, y })
        }
        ...
        function isStaticPositioned(element) {
          return 'static' === getComputedStyle(element).position
        }
        ...
        const floating_ui_dom_offset = function (options) {
                    ...
                    if (nextPlacement) {
                      if (
                        !(
                          ...
                          initialSideAxis !==
                            floating_ui_utils_getSideAxis(nextPlacement)
                        ) ||
                        overflowsData.every(
                          (d) =>
                            d.overflows[0] > 0 &&
          ...
          floating_ui_dom_size = function (options) {
            return (
              void 0 === options && (options = {}),
              {
                name: 'size',
                ...
                async fn(state) {
                  ...
                  const { placement, rects, platform, elements } = state,
                    ...
                    side = floating_ui_utils_getSide(placement),
                    alignment = floating_ui_utils_getAlignment(placement),
                    isYAxis = 'y' === floating_ui_utils_getSideAxis(placement),
                  ...
                  const maximumClippingHeight =
                    ...
                    overflowAvailableHeight = floating_ui_utils_min(
                      height - overflow[heightSide],
                      maximumClippingHeight
                    ),
                    overflowAvailableWidth = floating_ui_utils_min(
                  ...
                  if (
                    ...
                    const xMin = floating_ui_utils_max(overflow.left, 0),
                      xMax = floating_ui_utils_max(overflow.right, 0),
                      yMin = floating_ui_utils_max(overflow.top, 0),
                      yMax = floating_ui_utils_max(overflow.bottom, 0)
                    isYAxis
                      ? (availableWidth =
                          width -
                          2 *
          ...
          floating_ui_dom_hide = function (options) {
            return (
              void 0 === options && (options = {}),
              {
                name: 'hide',
          ...
          floating_ui_dom_limitShift = function (options) {
            return (
              void 0 === options && (options = {}),
              {
                options,
                fn(state) {
                  const { x, y, placement, rects, middlewareData } = state,
                    ...
                    coords = { x, y },
                    crossAxis = floating_ui_utils_getSideAxis(placement),
                    mainAxis = getOppositeAxis(crossAxis)
                  let mainAxisCoord = coords[mainAxis],
                    crossAxisCoord = coords[crossAxis]
    ...
    '../../node_modules/.pnpm/@floating-ui+react-dom@2.1.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
            '../../node_modules/.pnpm/@floating-ui+dom@1.7.2/node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs'
          ),
        ...
        function useFloating(options) {
          ...
          const [_reference, _setReference] =
            ...
            [_floating, _setFloating] =
              react__WEBPACK_IMPORTED_MODULE_0__.useState(null),
            setReference = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(
              (node) => {
            ...
            setFloating = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(
              (node) => {
            ...
            update = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(() => {
              ...
              ;(platformRef.current && (config.platform = platformRef.current),
                (0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.rD)(
        ...
        const arrow$1 = (options) => ({
            ...
            fn(state) {
              ...
              return element &&
                ...
                ? null != element.current
                  ? (0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.UE)({
          ...
          offset = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.cY)(options),
            options: [options, deps],
          }),
          shift = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.BN)(options),
            options: [options, deps],
          }),
          limitShift = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.ER)(options),
            options: [options, deps],
          }),
          flip = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.UU)(options),
            options: [options, deps],
          }),
          size = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.Ej)(options),
            options: [options, deps],
          }),
          hide = (options, deps) => ({
            ...(0, _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__.jD)(options),
            options: [options, deps],
          }),
          arrow = (options, deps) => ({
            ...arrow$1(options),
