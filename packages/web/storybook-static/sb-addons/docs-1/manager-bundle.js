try {
  ;(() => {
    ...
    const Zt = __STORYBOOK_COMPONENTS__,
      {
        A: Jt,
        ActionBar: Gt,
        AddonPanel: Z,
    ...
    const ia = __STORYBOOK_API__,
      {
        ...
        eventMatchesShortcut: ba,
        eventToShortcut: ga,
        experimental_MockUniversalStore: ya,
        experimental_UniversalStore: va,
        experimental_getStatusStore: Sa,
        experimental_getTestProviderStore: xa,
        experimental_requestResponse: Ia,
        experimental_useStatusStore: Ta,
        experimental_useTestProviderStore: wa,
        experimental_useUniversalStore: ka,
        internal_fullStatusStore: _a,
        internal_fullTestProviderStore: Pa,
        internal_universalStatusStore: Ea,
        internal_universalTestProviderStore: Ca,
        isMacLike: Oa,
        isShortcutTaken: Ra,
        keyToSymbol: Fa,
        merge: ja,
        mockChannel: za,
        optionOrAltSymbol: Ma,
        shortcutMatchesShortcut: Aa,
        shortcutToHumanString: Na,
        types: K,
        useAddonState: Ha,
        useArgTypes: Ba,
        useArgs: La,
        ...
        useStoryPrepared: qa,
        useStorybookApi: $a,
        useStorybookState: Wa,
      } = __STORYBOOK_API__
    const Ka = __STORYBOOK_THEMING__,
      {
        CacheProvider: Qa,
        ClassNames: Va,
        Global: en,
...
`,
    ...
    const ve = /^#[a-fA-F0-9]{6}$/,
      ...
      xe = /^#[a-fA-F0-9]{3}$/,
      Ie = /^#[a-fA-F0-9]{4}$/,
      H = /^rgb\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*\)$/i,
      Te =
    ...
    function x(e) {
      ...
      const o = Te.exec(t.substring(0, 50))
      if (o)
        return {
          red: parseInt(`${o[1]}`, 10),
      ...
      const f = ke.exec(t.substring(0, 50))
      if (f) {
        const T = parseInt(`${f[1]}`, 10),
          pe = parseInt(`${f[2]}`, 10) / 100,
          le = parseInt(`${f[3]}`, 10) / 100,
          $ = `rgb(${E(T, pe, le)})`,
          C = H.exec($)
        if (!C) throw new b(4, t, $)
        return {
          red: parseInt(`${C[1]}`, 10),
    ...
    function Oe(e, t, r, a) {
      if (
        ...
        return a >= 1 ? R(e, t, r) : `rgba(${E(e, t, r)},${a})`
      if (typeof e === 'object' && t === void 0 && r === void 0 && a === void 0)
        return e.alpha >= 1
          ? R(e.hue, e.saturation, e.lightness)
    ...
    function F(e, t, r, a) {
      if (typeof e === 'string' && typeof t === 'number') {
        ...
        if (
          ...
          return a >= 1 ? U(e, t, r) : `rgba(${e},${t},${r},${a})`
        if (
          typeof e === 'object' &&
          t === void 0 &&
          r === void 0 &&
    ...
    function Ae(e, t) {
      if (t === 'transparent') return t
      const r = g(t)
      return y(d({}, r, { lightness: I(0, 1, r.lightness - parseFloat(e)) }))
    }
    c(Ae)
    function Ne(e, t) {
      if (t === 'transparent') return t
      const r = g(t)
      return y(d({}, r, { saturation: I(0, 1, r.saturation - parseFloat(e)) }))
    }
    c(Ne)
    function He(e, t) {
      if (t === 'transparent') return t
    ...
    function De(e, t) {
      ...
      const r = x(t),
        ...
        n = d({}, r, { alpha: I(0, 1, (a * 100 + parseFloat(e) * 100) / 100) })
      return F(n)
    }
    c(De)
    function Ye(e, t) {
    ...
    function Ze(e, t) {
      ...
      const r = x(t),
        a = typeof r.alpha === 'number' ? r.alpha : 1,
        n = d({}, r, {
          alpha: I(0, 1, +(a * 100 - parseFloat(e) * 100).toFixed(2) / 100),
        })
      return F(n)
    }
    const Je = c(Ze),
      ...
      tt = () =>
        u.createElement(
          ...
          u.createElement(O, { style: { width: '80%' } }),
          u.createElement(O, { style: { width: '30%' } }),
          u.createElement(O, { style: { width: '80%' } })
        ),
      rt = ({
        isLoading: e,
        ...
        if (e) return u.createElement(tt, null)
        if (t) return u.createElement(Qe, null, t)
        ...
        const l = n ? M.dark : M.light
        return u.createElement(
          ee,
          {
            theme: te({ ...l, fontCode: i.fonts.mono, fontBase: i.fonts.base }),
          },
          p
        )
      }
      ...
      j.add(ue, {
        ...
        render: ({ active: t }) => {
          const r = e.getChannel(),
            ...
            n = r?.last(ae)?.[0],
            [o, s] = X({ source: n?.source, format: n?.format ?? void 0 }),
    ...
    var at = S.div(() => ({
      height: '100%',
      [`> :first-child${z}`]: { margin: 0, height: '100%', boxShadow: 'none' },
    }))
  })()
} catch (e) {
  console.error(
