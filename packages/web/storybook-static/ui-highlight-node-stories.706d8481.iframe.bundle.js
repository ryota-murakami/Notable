...
;(self.webpackChunk_notable_web = self.webpackChunk_notable_web || []).push([
  [4807],
  {
    ...
    './components/ui/highlight-node.stories.tsx': (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
                ...
                ? [
                    {
                      ...
                      children: [
                        { text: context },
                        { text: content, highlight: !0 },
                        { text: ' for emphasis.' },
                      ],
                    },
                  ]
                : [{ type: 'p', children: [{ text: content, highlight: !0 }] }],
        ...
        Default = { args: { content: 'Important text' } },
        InContext = {
          args: { content: ' this part ', context: 'Pay attention to' },
        },
        MultipleHighlights = {
          render: () => {
              ...
              value: [
                {
                  ...
                  children: [
                    ...
                    { text: 'multiple', highlight: !0 },
                    { text: ' words ' },
                    { text: 'highlighted', highlight: !0 },
                    { text: ' to show ' },
                    { text: 'emphasis', highlight: !0 },
                    { text: '.' },
                  ],
                },
              ],
              ...
              value: [
                {
                  ...
                  children: [
                    ...
                    { text: 'bold', highlight: !0, bold: !0 },
                    { text: ', ' },
                    { text: 'italic', highlight: !0, italic: !0 },
                    { text: ', or ' },
                    { text: 'both', highlight: !0, bold: !0, italic: !0 },
          ...
          render: () => {
            const editor = (0, platejs_react__WEBPACK_IMPORTED_MODULE_5__.FI)({
              plugins:
                _components_editor_plugins_basic_nodes_kit__WEBPACK_IMPORTED_MODULE_2__.u,
              value: [
                { type: 'h2', children: [{ text: 'Document Review' }] },
                {
                  type: 'p',
                  children: [
                    { text: 'During review, ' },
                    { text: 'important sections', highlight: !0 },
                ...
                },
                {
                  ...
                  children: [
                    { text: 'Reviewers can ' },
                    { text: 'mark specific phrases', highlight: !0 },
                    { text: ' that need attention or ' },
                    { text: 'require changes', highlight: !0 },
                    { text: '.' },
                  ],
                },
              ],
              ...
              value: [
                {
                  ...
                  children: [
                    ...
                    { text: 'handleClick()', code: !0 },
                    { text: ', the line ' },
                    { text: 'event.preventDefault()', code: !0, highlight: !0 },
        ...
        InteractiveHighlight = {
          args: { content: 'Click to edit this highlight' },
          play: async ({ canvasElement }) => {
            ...
            const editor = canvas.getByRole('textbox'),
              highlight = canvas.getByText('Click to edit this highlight')
            ;(await _storybook_test__WEBPACK_IMPORTED_MODULE_4__.Q4.click(
              ...
              await (0, _storybook_test__WEBPACK_IMPORTED_MODULE_4__.E3)(
                editor
              ).toHaveTextContent('Click to edit this highlight - edited!'))
          },
        },
        CreateHighlight = {
          render: () => {
          ...
          play: async ({ canvasElement }) => {
            ...
            ;(await _storybook_test__WEBPACK_IMPORTED_MODULE_4__.Q4.click(text),
              await _storybook_test__WEBPACK_IMPORTED_MODULE_4__.Q4.keyboard(
                '{Home}'
              ))
            for (let i = 0; i < 7; i++)
      ...
      ;((Default.parameters = {
        ...
        (MultipleHighlights.parameters = {
          ...MultipleHighlights.parameters,
          docs: {
            ...MultipleHighlights.parameters?.docs,
            source: {
              originalSource:
                "{\n  render: () => {\n    const editor = usePlateEditor({\n      plugins: BasicNodesKit,\n      value: [{\n        type: 'p',\n        children: [{\n          text: 'This paragraph has '\n        }, {\n          text: 'multiple',\n          highlight: true\n        }, {\n          text: ' words '\n        }, {\n          text: 'highlighted',\n          highlight: true\n        }, {\n          text: ' to show '\n        }, {\n          text: 'emphasis',\n          highlight: true\n        }, {\n          text: '.'\n        }]\n      }]\n    });\n    return <Plate editor={editor}>\n        <EditorContainer>\n          <Editor variant='demo' />\n        </EditorContainer>\n      </Plate>;\n  }\n}",
              ...MultipleHighlights.parameters?.docs?.source,
            },
          },
        }),
        (LongHighlight.parameters = {
          ...LongHighlight.parameters,
          docs: {
            ...LongHighlight.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    content: 'This is a very long piece of highlighted text that demonstrates how highlighting works with wrapped lines'\n  }\n}",
              ...LongHighlight.parameters?.docs?.source,
            },
          },
        }),
        ...
        (SearchResults.parameters = {
          ...SearchResults.parameters,
          docs: {
            ...SearchResults.parameters?.docs,
            source: {
              originalSource:
                "{\n  render: () => {\n    const editor = usePlateEditor({\n      plugins: BasicNodesKit,\n      value: [{\n        type: 'p',\n        children: [{\n          text: 'When searching for \"example\", all instances of '\n        }, {\n          text: 'example',\n          highlight: true\n        }, {\n          text: ' are highlighted. This '\n        }, {\n          text: 'example',\n          highlight: true\n        }, {\n          text: ' shows how search highlighting works.'\n        }]\n      }]\n    });\n    return <Plate editor={editor}>\n        <EditorContainer>\n          <Editor variant='demo' />\n        </EditorContainer>\n      </Plate>;\n  }\n}",
              ...SearchResults.parameters?.docs?.source,
            },
          },
        }),
        (DocumentReview.parameters = {
          ...DocumentReview.parameters,
          docs: {
            ...DocumentReview.parameters?.docs,
            source: {
              originalSource:
                "{\n  render: () => {\n    const editor = usePlateEditor({\n      plugins: BasicNodesKit,\n      value: [{\n        type: 'h2',\n        children: [{\n          text: 'Document Review'\n        }]\n      }, {\n        type: 'p',\n        children: [{\n          text: 'During review, '\n        }, {\n          text: 'important sections',\n          highlight: true\n        }, {\n          text: ' are highlighted for discussion.'\n        }]\n      }, {\n        type: 'p',\n        children: [{\n          text: 'Reviewers can '\n        }, {\n          text: 'mark specific phrases',\n          highlight: true\n        }, {\n          text: ' that need attention or '\n        }, {\n          text: 'require changes',\n          highlight: true\n        }, {\n          text: '.'\n        }]\n      }]\n    });\n    return <Plate editor={editor}>\n        <EditorContainer>\n          <Editor variant='demo' />\n        </EditorContainer>\n      </Plate>;\n  }\n}",
              ...DocumentReview.parameters?.docs?.source,
            },
          },
        }),
        (CodeSnippets.parameters = {
          ...CodeSnippets.parameters,
          docs: {
            ...CodeSnippets.parameters?.docs,
            source: {
              originalSource:
                "{\n  render: () => {\n    const editor = usePlateEditor({\n      plugins: BasicNodesKit,\n      value: [{\n        type: 'p',\n        children: [{\n          text: 'In the function '\n        }, {\n          text: 'handleClick()',\n          code: true\n        }, {\n          text: ', the line '\n        }, {\n          text: 'event.preventDefault()',\n          code: true,\n          highlight: true\n        }, {\n          text: ' is crucial for preventing default behavior.'\n        }]\n      }]\n    });\n    return <Plate editor={editor}>\n        <EditorContainer>\n          <Editor variant='demo' />\n        </EditorContainer>\n      </Plate>;\n  }\n}",
              ...CodeSnippets.parameters?.docs?.source,
            },
          },
        }),
        (InteractiveHighlight.parameters = {
          ...InteractiveHighlight.parameters,
          docs: {
            ...InteractiveHighlight.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    content: 'Click to edit this highlight'\n  },\n  play: async ({\n    canvasElement\n  }) => {\n    const canvas = within(canvasElement);\n\n    // Wait for editor to render\n    await new Promise(resolve => setTimeout(resolve, 100));\n    const editor = canvas.getByRole('textbox');\n    const highlight = canvas.getByText('Click to edit this highlight');\n\n    // Click on the highlight\n    await userEvent.click(highlight);\n\n    // Add text at the end\n    await userEvent.keyboard('{End}');\n    await userEvent.type(editor, ' - edited!');\n\n    // Verify the change\n    await expect(editor).toHaveTextContent('Click to edit this highlight - edited!');\n  }\n}",
              ...InteractiveHighlight.parameters?.docs?.source,
            },
          },
        }),
        (CreateHighlight.parameters = {
          ...CreateHighlight.parameters,
          docs: {
            ...CreateHighlight.parameters?.docs,
            source: {
              originalSource:
                "{\n  render: () => {\n    const editor = usePlateEditor({\n      plugins: BasicNodesKit,\n      value: [{\n        type: 'p',\n        children: [{\n          text: 'Select any text in this paragraph and apply highlighting to make it stand out.'\n        }]\n      }]\n    });\n    return <Plate editor={editor}>\n        <EditorContainer>\n          <Editor variant='demo' />\n        </EditorContainer>\n      </Plate>;\n  },\n  play: async ({\n    canvasElement\n  }) => {\n    const canvas = within(canvasElement);\n\n    // Wait for editor to render\n    await new Promise(resolve => setTimeout(resolve, 100));\n    const editor = canvas.getByRole('textbox');\n\n    // Select \"any text\"\n    const text = canvas.getByText(/Select any text/);\n    await userEvent.click(text);\n\n    // Move to \"any text\" and select it\n    await userEvent.keyboard('{Home}');\n    for (let i = 0; i < 7; i++) {\n      await userEvent.keyboard('{ArrowRight}');\n    }\n    await userEvent.keyboard('{Shift>}{ArrowRight}{ArrowRight}{ArrowRight}{ArrowRight}{ArrowRight}{ArrowRight}{ArrowRight}{ArrowRight}{/Shift}');\n\n    // Note: Actual highlighting would depend on toolbar/keyboard implementation\n  }\n}",
              ...CreateHighlight.parameters?.docs?.source,
            },
          },
        }))
    },
