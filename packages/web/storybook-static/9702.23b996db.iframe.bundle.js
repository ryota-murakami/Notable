/*! For license information please see 9702.23b996db.iframe.bundle.js.LICENSE.txt */
'use strict'
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
              ...
              children: (0, jsx_runtime.jsx)(ScrollLockWrapper, {
                ...
                children: (0, jsx_runtime.jsx)(react_focus_scope_dist.n, {
                  ...
                  children: (0, jsx_runtime.jsx)(
                    react_dismissable_layer_dist.qW,
                    {
                      asChild: !0,
                      disableOutsidePointerEvents,
                      onEscapeKeyDown,
        ...
        var MenuArrow = react.forwardRef((props, forwardedRef) => {
          const { __scopeMenu, ...arrowProps } = props,
            popperScope = usePopperScope(__scopeMenu)
          return (0, jsx_runtime.jsx)(react_popper_dist.i3, {
            ...popperScope,
            ...arrowProps,
            ref: forwardedRef,
          })
        ...
        var Root3 = Menu,
          ...
          [createDropdownMenuContext, createDropdownMenuScope] = (0,
          react_context_dist.A)('DropdownMenu', [createMenuScope]),
          useMenuScope = createMenuScope(),
          [DropdownMenuProvider, useDropdownMenuContext] =
            createDropdownMenuContext('DropdownMenu'),
          DropdownMenu = (props) => {
            const {
                __scopeDropdownMenu,
                children,
        ...
        var DropdownMenuTrigger = react.forwardRef((props, forwardedRef) => {
          const { __scopeDropdownMenu, disabled = !1, ...triggerProps } = props,
            context = useDropdownMenuContext(
              'DropdownMenuTrigger',
              __scopeDropdownMenu
            ),
            menuScope = useMenuScope(__scopeDropdownMenu)
          ...
          return (0, jsx_runtime.jsx)(Content2, {
            ...
            onInteractOutside: (0, dist.m)(props.onInteractOutside, (event) => {
              const originalEvent = event.detail.originalEvent,
                ctrlLeftClick =
                  0 === originalEvent.button && !0 === originalEvent.ctrlKey,
                isRightClick = 2 === originalEvent.button || ctrlLeftClick
              ;(context.modal && !isRightClick) ||
        ...
        var DropdownMenuItemIndicator = react.forwardRef(
          (props, forwardedRef) => {
