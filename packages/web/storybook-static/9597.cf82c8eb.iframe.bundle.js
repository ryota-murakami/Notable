...
;(self.webpackChunk_notable_web = self.webpackChunk_notable_web || []).push([
  [9597],
  {
    '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/DocsRenderer-PQXLIZUC.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var react = __webpack_require__(
          ...
          react_18 = __webpack_require__(
            '../../node_modules/.pnpm/@storybook+react-dom-shim@9.0.18_react-dom@19.1.0_react@19.1.0__react@19.1.0_storybook@_f24d713234745710ecafa9aac07b2f9a/node_modules/@storybook/react-dom-shim/dist/react-18.mjs'
          ),
          chunk_SPFYY5GD = __webpack_require__(
            '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/chunk-SPFYY5GD.mjs'
          ),
          chunk_QUZPS4B6 = __webpack_require__(
            '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/chunk-QUZPS4B6.mjs'
          ),
          ...
          docs_tools = __webpack_require__(
            '../../node_modules/.pnpm/storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2/node_modules/storybook/dist/docs-tools/index.js'
          )
            ...
            return matches
              ? arr.concat(
                  matches.map(function (match) {
                    ...
                    return null !==
                      (_b =
                        null === (_a = match.match(/[\t ]/g)) || void 0 === _a
                          ? void 0
                          : _a.length) && void 0 !== _b
                      ? _b
                      : 0
        ...
        var external_STORYBOOK_MODULE_CHANNELS_ = __webpack_require__(
          ...
          require_memoizerific = (0, chunk_QUZPS4B6.P$)({
                ...
                return (function e2(t2, n2, r2) {
                  function s2(o3, u2) {
                    if (!n2[o3]) {
                      if (!t2[o3]) {
                        var a2 =
                          'function' == typeof chunk_QUZPS4B6.ki &&
                          chunk_QUZPS4B6.ki
        ...
        var reduceHexValue$1 = function (value2) {
          return 7 === value2.length &&
            value2[1] === value2[2] &&
            value2[3] === value2[4] &&
            value2[5] === value2[6]
        ...
        function rgb(value2, green, blue) {
          ...
          if ('object' == typeof value2 && void 0 === green && void 0 === blue)
            return reduceHexValue$1(
              '#' +
        ...
        function toColorString(color) {
          ...
          if (
            ...
            return (function hsla(value2, saturation, lightness, alpha) {
              if (
                'number' == typeof value2 &&
                ...
                return alpha >= 1
                  ...
                  : 'rgba(' +
                      hslToRgb(value2, saturation, lightness) +
                      ',' +
                      alpha +
                      ')'
              if (
          ...
          if (
            ...
            return (function hsl(value2, saturation, lightness) {
              if (
                'number' == typeof value2 &&
                'number' == typeof saturation &&
                'number' == typeof lightness
        ...
        curry(function adjustHue(degree, color) {
          ...
          return toColorString(
            _extends({}, hslColor, { hue: hslColor.hue + parseFloat(degree) })
          )
        })
        ...
        var mix$1 = curry(function mix(weight, color, otherColor) {
          ...
          var parsedColor1 = parseToRgb(color),
            color1 = _extends({}, parsedColor1, {
              alpha:
                'number' == typeof parsedColor1.alpha ? parsedColor1.alpha : 1,
            }),
            parsedColor2 = parseToRgb(otherColor),
            color2 = _extends({}, parsedColor2, {
              alpha:
                'number' == typeof parsedColor2.alpha ? parsedColor2.alpha : 1,
            }),
            alphaDelta = color1.alpha - color2.alpha,
            x2 = 2 * parseFloat(weight) - 1,
            weight1 =
              ((x2 * alphaDelta === -1 ? x2 : x2 + alphaDelta) /
                (1 + x2 * alphaDelta) +
                1) /
              2,
            weight2 = 1 - weight1
        ...
        ;(curry(function saturate(amount, color) {
          ...
          curry(function setHue(hue, color) {
            return 'transparent' === color
              ? color
              : toColorString(
                  _extends({}, parseToHsl(color), { hue: parseFloat(hue) })
                )
          }),
          ...
          curry(function shade(percentage, color) {
            return 'transparent' === color
              ? color
              : mix$1(parseFloat(percentage), 'rgb(0, 0, 0)', color)
          }),
          curry(function tint(percentage, color) {
            return 'transparent' === color
              ? color
              : mix$1(parseFloat(percentage), 'rgb(255, 255, 255)', color)
          }))
        var curriedTransparentize$1 = curry(
          ...
          Wrapper = theming.I4.div(components.YV, ({ theme }) => ({
            backgroundColor:
              'light' === theme.base
                ? 'rgba(0,0,0,.01)'
                : 'rgba(255,255,255,.01)',
          ...
          StyledSyntaxHighlighter = (0, theming.I4)(components.bF)(
            ({ theme }) => ({
          ...
          SourceSkeletonWrapper = theming.I4.div(({ theme }) => ({
          ...
          SourceSkeletonPlaceholder = theming.I4.div(({ theme }) => ({
            animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
            background: theme.appBorderColor,
            height: 17,
            marginTop: 1,
            width: '60%',
            [`&:first-child${theming.v_}`]: { margin: 0 },
          })),
          SourceSkeleton = () =>
            react.createElement(
          ...
          Source = ({
            ...
            let overrideTheme = dark ? theming.Zj.dark : theming.Zj.light
          ...
          Title = theming.I4.h1(components.YV, ({ theme }) => ({
          ...
          Subtitle = theming.I4.h2(components.YV, ({ theme }) => ({
          ...
          DocsContent = theming.I4.div(({ theme }) => {
            let reset = {
          ...
          DocsWrapper = theming.I4.div(({ theme }) => ({
            background: theme.background.content,
            display: 'flex',
          ...
          IFrame = class extends react.Component {
            constructor() {
          ...
          InlineStory = (props) => {
            let storyRef = (0, react.useRef)(),
              [showLoader, setShowLoader] = (0, react.useState)(!0),
            ...
            return (
              ...
              error
                ? react.createElement(
                    'pre',
                    null,
                    react.createElement(components.Df, { error })
                  )
                : react.createElement(
                    react.Fragment,
                    null,
          ...
          IFrameStory = ({ story, height = '500px' }) =>
            react.createElement(
              ...
              react.createElement(ZoomContext.Consumer, null, ({ scale }) =>
                react.createElement(IFrame, {
                  key: 'iframe',
                  id: `iframe--${story.id}`,
                  title: story.name,
                  src: (0, components.jZ)(BASE_URL, story.id, {
                    viewMode: 'story',
                  }),
                  allowFullScreen: !0,
                  scale,
          ...
          ErrorMessage = theming.I4.strong(({ theme }) => ({
          ...
          StorySkeleton = () => react.createElement(components.aH, null),
          Bar = (0, theming.I4)(components.px)({
            position: 'absolute',
            left: 0,
            right: 0,
            top: 0,
          ...
          Wrapper2 = theming.I4.div({
            display: 'flex',
            alignItems: 'center',
            gap: 4,
          }),
          IconPlaceholder = theming.I4.div(({ theme }) => ({
            width: 14,
            height: 14,
            borderRadius: 2,
            margin: '0 7px',
          ...
          ChildrenContainer = theming.I4.div(
          ...
          StyledSource = (0, theming.I4)(Source)(({ theme }) => ({
            margin: 0,
        ...
        var PositionedToolbar = (0, theming.I4)(
            ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) =>
              react.createElement(
                ...
                react.createElement(
                  ...
                  isLoading
                    ? [1, 2, 3].map((key) =>
                        react.createElement(IconPlaceholder, { key })
                      )
                    : react.createElement(
                        react.Fragment,
                        null,
                        react.createElement(
                          ...
                          react.createElement(dist.PU, null)
                        ),
                        react.createElement(
                          components.K0,
                          {
                          ...
                          react.createElement(dist.LoD, null)
                        ),
                        react.createElement(
                          components.K0,
                          {
                          ...
                          react.createElement(dist.wV5, null)
                        )
                      )
                )
              )
          )({ position: 'absolute', top: 0, left: 0, right: 0, height: 40 }),
          Relative = theming.I4.div({
            overflow: 'hidden',
            position: 'relative',
          }),
          Preview = ({
            ...
            let [expanded, setExpanded] = (0, react.useState)(isExpanded),
              { source, actionItem } = ((withSource, expanded, setExpanded) => {
                switch (!0) {
                  ...
                  case expanded:
                    return {
                      source: react.createElement(StyledSource, {
                        ...withSource,
                        dark: !0,
                      }),
                      actionItem: {
              ...
              [scale, setScale] = (0, react.useState)(1),
              ...
              react.useState)(additionalActions ? [...additionalActions] : []),
              actionItems = [...defaultActionItems, ...additionalActionItems],
              { window: globalWindow4 } = globalThis,
              copyToClipboard = (0, react.useCallback)(async (text) => {
                    ...
                    react.createElement(
                      ...
                      Array.isArray(children)
                        ? children.map((child, i2) =>
                            react.createElement('div', { key: i2 }, child)
                          )
                        : react.createElement('div', null, children)
                    )
                  ),
                  react.createElement(components.E7, { actionItems })
                )
              ),
              withSource && expanded && source
            )
          }
        ;(0, theming.I4)(Preview)(() => ({
        ...
        ;(theming.I4.div(({ theme }) => ({
          ...
          theming.I4.div(components.YV, ({ theme }) => ({
            ...getBlockBackgroundStyle(theme),
            margin: '25px 0 40px',
            padding: '30px 20px',
          })),
          ...
          theming.I4.div({ flex: '0 0 30%', lineHeight: '20px', marginTop: 5 }),
          theming.I4.div(({ theme }) => ({
            flex: 1,
            textAlign: 'center',
            fontFamily: theme.typography.fonts.mono,
          ...
          theming.I4.div({ display: 'flex', flexDirection: 'row' }),
          theming.I4.div(({ background }) => ({
            position: 'relative',
            flex: 1,
            '&::before': {
              position: 'absolute',
          ...
          theming.I4.div({ flex: 1, display: 'flex', flexDirection: 'row' }),
          theming.I4.div({ display: 'flex', alignItems: 'flex-start' }),
          theming.I4.div({ flex: '0 0 30%' }),
          theming.I4.div({ flex: 1 }),
          theming.I4.div(({ theme }) => ({
            display: 'flex',
            flexDirection: 'row',
            alignItems: 'center',
        ...
        function build_html_default(options) {
          ...
          function createEl(d2, container) {
            let link = container.appendChild(
              (function createLink(data) {
                ...
                return (
                  ...
                  options.onClick && (a2.onclick = options.onClick),
                  options.includeTitleTags &&
                  ...
                  a2.setAttribute(
                    'class',
                    `${options.linkClass + ' '}node-name--${data.nodeName} ${options.extraLinkClasses}`
                  ),
                  item.appendChild(a2),
                  item
                )
          ...
          function createList(isCollapsed) {
            let listElement = options.orderedList ? 'ol' : 'ul',
              ...
              classes = options.listClass + ' ' + options.extraListClasses
            return (
              isCollapsed &&
                ((classes = classes + ' ' + options.collapsibleClass),
                (classes = classes + ' ' + options.isCollapsedClass)),
          ...
          function updateClassname(obj, className) {
            return (
              obj && obj.className !== className && (obj.className = className),
              obj
            )
          }
          function removeCollapsedFromParents(element) {
            return element &&
              -1 !== element.className.indexOf(options.collapsibleClass) &&
              -1 !== element.className.indexOf(options.isCollapsedClass)
              ? (updateClassname(
                  element,
                  element.className.replace(' ' + options.isCollapsedClass, '')
                ),
          ...
          function getIsHeaderBottomMode(headerId) {
            ...
            return (
              (document?.getElementById(headerId)).offsetTop >
              scrollEl.offsetHeight -
                1.4 * scrollEl.clientHeight -
            ...
            return (
              some.call(headings, (heading, i2) => {
                if (
                  ...
                  return ((topHeader = headings[0 === i2 ? i2 : i2 - 1]), !0)
                }
          ...
          return {
            ...
            disableTocAnimation: function disableTocAnimation(event) {
              ...
              'string' != typeof target.className ||
                -1 === target.className.indexOf(options.linkClass) ||
            ...
            updateToc: function updateToc(headingsArray, event) {
              options.positionFixedSelector &&
                (function updateFixedSidebarClass() {
                  let scrollTop = getScrollTop(),
                    posFixedEl = document.querySelector(
                      options.positionFixedSelector
                    )
                  ;('auto' === options.fixedSidebarOffset &&
                    (options.fixedSidebarOffset = tocElement.offsetTop),
                    scrollTop > options.fixedSidebarOffset
                      ? -1 ===
                          posFixedEl.className.indexOf(
                            options.positionFixedClass
                          ) &&
              ...
              let headings = headingsArray,
                clickedHref = event?.target?.getAttribute
              ...
              if (
                ...
                (currentlyHighlighting || isBottomMode) &&
                  tocElement &&
                  headings.length > 0)
              ) {
                ...
                let tocLinks = tocElement.querySelectorAll(
                  `.${options.linkClass}`
                )
                forEach.call(tocLinks, (tocLink) => {
                  updateClassname(
                    tocLink,
                    tocLink.className.replace(' ' + options.activeLinkClass, '')
                  )
                })
                let tocLis = tocElement.querySelectorAll(
                  `.${options.listItemClass}`
                )
                ;(forEach.call(tocLis, (tocLi) => {
                  ...
                  activeTocLink &&
                    ...
                    (activeTocLink.className += ' ' + options.activeLinkClass))
                let li = activeTocLink?.parentNode
                li &&
                  -1 === li.className.indexOf(options.activeListItemClass) &&
                  (li.className += ' ' + options.activeListItemClass)
                let tocLists = tocElement.querySelectorAll(
                  `.${options.listClass}.${options.collapsibleClass}`
                )
                ;(forEach.call(tocLists, (list) => {
                  ;-1 === list.className.indexOf(options.isCollapsedClass) &&
                  ...
                  removeCollapsedFromParents(
                    activeTocLink?.parentNode.parentNode
                  ))
              }
            },
            getCurrentlyHighlighting: function getCurrentlyHighlighting() {
              return currentlyHighlighting
            },
            getTopHeader,
            getScrollTop,
            updateUrlHashForHeader: function updateUrlHashForHeader(
              headingsArray
            ) {
              let scrollTop = getScrollTop(),
                    ...
                    currentHeading &&
                      (function addNode(node, nest) {
                        let obj = getHeadingObject(node),
                          ...
                          counter =
                            level - (lastItem ? lastItem.headingLevel : 0)
                        for (
                          ;
                          counter > 0 &&
                          ((lastItem = getLastItem(array2)),
              ...
              document.body.addEventListener(
                ...
                function onClick(e2) {
                  !(function isInPageLink(n2) {
                    ...
                    -1 === e2.target.className.indexOf(options.linkClass) ||
                    (function jump(target, options) {
                      ...
                      function end() {
                        ;(window.scrollTo(0, start + distance),
                          'function' == typeof opt.callback && opt.callback())
                      }
        ...
        function init(customOptions) {
          ...
          ;((_options = (function extend(...args) {
            ...
            return target
          })(default_options_default, customOptions || {})).scrollSmooth &&
            ...
            destroy())
          let contentElement = (function getContentElement(options) {
            try {
              return (
          ...
          if (
            ...
            return
          let nestedHeadings =
            _parseContent.nestHeadingsArray(_headingsArray).nest
          if (_options.skipRendering) return this
          _buildHtml.render(tocElement, nestedHeadings)
          let isClick = !1,
            scrollHandlerTimeout =
              _options.scrollHandlerTimeout || _options.throttleTimeout
          ;((_scrollListener = (function getScrollHandler(
            func,
            timeout,
            type = 'auto'
          ) {
                ...
                !_options.disableTocScrollSync &&
                  ...
                  (function updateTocScroll(options) {
                    ...
                    if (toc && toc.scrollHeight > toc.clientHeight) {
                      let activeItem = toc.querySelector(
                        `.${options.activeListItemClass}`
                      )
                      if (activeItem) {
                        let scrollAmount =
                          activeItem.offsetTop - options.tocScrollOffset
                        toc.scrollTop = scrollAmount > 0 ? scrollAmount : 0
                      }
                    }
                  })(_options),
                _options.enableUrlHashUpdateOnScroll &&
                  hasInitialized &&
                  _buildHtml.getCurrentlyHighlighting() &&
                  _buildHtml.updateUrlHashForHeader(_headingsArray))
              let isTop = 0 === e2?.target?.scrollingElement?.scrollTop
              ;((e2 && (0 === e2.eventPhase || null === e2.currentTarget)) ||
                isTop) &&
                (_buildHtml.updateToc(_headingsArray),
                _options.scrollEndCallback?.(e2))
            },
            scrollHandlerTimeout,
            _options.scrollHandlerType
          )),
        ...
        var tocbot_default = {
            destroy,
            init,
            refresh: function refresh(customOptions) {
              ;(destroy(), init(customOptions || _options))
            },
          },
          Aside = theming.I4.aside(() => ({
            width: '10rem',
            '@media (max-width: 768px)': { display: 'none' },
          })),
          Nav = theming.I4.nav(({ theme }) => ({
            position: 'fixed',
            bottom: 0,
            top: 0,
            width: '10rem',
          ...
          Title2 = ({ headingId, title }) =>
            'string' != typeof title && title
              ? react.createElement('div', { id: headingId }, title)
              : react.createElement(
                  Heading,
                  {
                    as: 'h2',
          ...
          TableOfContents = ({
            ...
            ;(0, react.useEffect)(() => {
              ...
              let configuration = {
                ...
                timeout = setTimeout(
                  () => tocbot_default.init(configuration),
                  100
                )
              return () => {
            ...
            return react.createElement(
              ...
              disable
                ...
                : react.createElement(
                    ...
                    react.createElement(Title2, { headingId, title }),
                    react.createElement('div', { className: 'toc-wrapper' })
                  )
            )
          }
        function t() {
        ...
        var i,
          ...
          r_codeInline = '5',
          r_footnote = '6',
          r_footnoteReference = '7',
          r_gfmTask = '8',
          r_heading = '9',
          r_headingSetext = '10',
          r_htmlBlock = '11',
          r_htmlComment = '12',
          r_htmlSelfClosing = '13',
          r_image = '14',
          r_link = '15',
          r_linkAngleBraceStyleDetector = '16',
          r_linkBareUrlDetector = '17',
          r_linkMailtoDetector = '18',
          r_newlineCoalescer = '19',
          r_orderedList = '20',
          r_paragraph = '21',
          r_ref = '22',
          r_refImage = '23',
          ...
          return {
            ...
            render: (t3, n3, i3) =>
              e2(
                ...
                {
                  key: i3.key,
                  start: t3.type === r_orderedList ? t3.start : void 0,
                },
        ...
        function Te(e2, t2, n2) {
          ...
          return (
            (n2.inline = !1),
            l2.length
              ? { align: i2, cells: l2, header: o2, type: r_table }
              : { children: o2, type: r_paragraph }
          )
        }
        function Be(e2, t2) {
        ...
        var index_modern_default = (t2) => {
            ...
            return react.cloneElement(
              (function Xe(n2 = '', i2 = {}) {
                ...
                function Z2(e2) {
                  ...
                  i2.forceInline
                    ? (t2 = !0)
                    : i2.forceBlock || (t2 = !1 === W.test(e2))
                  let n3 = ae2(
                    oe2(t2 ? e2 : `${ze(e2).replace(ie, '')}\n\n`, {
                      inline: t2,
                    })
                  )
                  for (
                    ;
                    'string' == typeof n3[n3.length - 1] &&
                    !n3[n3.length - 1].trim();
                ...
                function q2(e2, t2) {
                  ...
                  return n3
                    ? n3.reduce(function (t3, n4) {
                        let r2 = n4.indexOf('=')
                        if (-1 !== r2) {
                          let o2 = ((e3 = n4.slice(0, r2)),
                            -1 !== e3.indexOf('-') &&
                              null === e3.match(M) &&
                              (e3 = e3.replace(j, function (e4, t4) {
                          ...
                          let d2 = (t3[s2] = (function (e3, t4, n5, r3) {
                            return 'style' === t4
                              ...
                              : -1 !== c.indexOf(t4)
                                ? r3(n5, e3, t4)
                                : (n5.match(I) &&
                                    (n5 = n5.slice(1, n5.length - 1)),
                                  'true' === n5 || ('false' !== n5 && n5))
                          })(e2, o2, a2, i2.sanitizer))
                          'string' == typeof d2 &&
                            (O.test(d2) || R.test(d2)) &&
                            (t3[s2] = Z2(d2.trim()))
                        } else 'style' !== n4 && (t3[l[n4] || n4] = !0)
                        var e3
                        return t3
                      }, {})
                    : null
                ...
                ;((i2.overrides = i2.overrides || {}),
                  (i2.sanitizer = i2.sanitizer || He),
                  (i2.slugify = i2.slugify || Le),
                  (i2.namedCodesToUnicode = i2.namedCodesToUnicode
                    ? t({}, o, i2.namedCodesToUnicode)
                    : o),
                  (i2.createElement = i2.createElement || react.createElement))
                let Q2 = [],
                  V2 = {},
                  X2 = {
                    [r_blockQuote]: {
                      ...
                      render(e2, t2, n3) {
                        ...
                        return (
                          e2.alert &&
                            ((l2.className =
                              'markdown-alert-' +
                              i2.slugify(e2.alert.toLowerCase(), Le)),
                            e2.children.unshift({
                              attrs: {},
                              children: [{ type: r_text, text: e2.alert }],
                              noInnerParse: !0,
                              type: r_htmlBlock,
                              tag: 'header',
                            })),
                    ...
                    [r_breakLine]: {
                      ...
                      order: 1,
                      parse: Ze,
                      render: (e2, t2, n3) => u2('br', { key: n3.key }),
                    },
                    [r_breakThematic]: {
                      match: De(g),
                      order: 1,
                      parse: Ze,
                      render: (e2, t2, n3) => u2('hr', { key: n3.key }),
                    },
                    [r_codeBlock]: {
                      match: De(k),
                      order: 0,
                      parse: (e2) => ({
                        lang: void 0,
                        text: ze(e2[0].replace(/^ {4}/gm, '')).replace(
                          ne,
                          '$1'
                        ),
                      }),
                    ...
                    [r_codeInline]: {
                      match: Ie(x),
                      order: 3,
                      parse: (e2) => ({ text: e2[2].replace(ne, '$1') }),
                      render: (e2, t2, n3) =>
                        u2('code', { key: n3.key }, e2.text),
                    },
                    [r_footnote]: {
                      match: De(C),
                      order: 0,
                      parse: (e2) => (
                        Q2.push({ footnote: e2[2], identifier: e2[1] }),
                        {}
                      ),
                      render: qe,
                    },
                    ...
                    [r_htmlBlock]: {
                      ...
                      parse(e2, t2, n3) {
                        let [, r2] = e2[3].match(le),
                          ...
                          l2 = e2[3].replace(i3, ''),
                          o2 =
                            ((c2 = l2), Ee.some((e3) => e3.test(c2)) ? We : _e)
                        var c2
                      ...
                      render: (e2, n3, r2) =>
                        u2(
                          ...
                          e2.text || (e2.children ? n3(e2.children, r2) : '')
                        ),
                    },
                    [r_htmlSelfClosing]: {
                      match: Ue(R),
                      ...
                      render: (e2, n3, r2) =>
                        u2(e2.tag, t({}, e2.attrs, { key: r2.key })),
                    },
                    [r_htmlComment]: {
                      match: Ue(B),
                      order: 1,
                    ...
                    [r_linkAngleBraceStyleDetector]: {
                      match: Re(N),
                      order: 0,
                      parse: (e2) => ({
                        children: [{ text: e2[1], type: r_text }],
                        target: e2[1],
                        type: r_link,
                      }),
                    },
                    [r_linkBareUrlDetector]: {
                      match: Me((e2, t2) =>
                        t2.inAnchor || i2.disableAutoLink ? null : Re(D)(e2, t2)
                      ),
                      order: 0,
                      parse: (e2) => ({
                        children: [{ text: e2[1], type: r_text }],
                    ...
                    [r_linkMailtoDetector]: {
                      ...
                      parse(e2) {
                        let t2 = e2[1],
                          n3 = e2[1]
                        return (
                          d.test(n3) || (n3 = 'mailto:' + n3),
                          {
                            children: [
                              { text: t2.replace('mailto:', ''), type: r_text },
                            ],
                            target: n3,
                            type: r_link,
                          }
                    ...
                    [r_orderedList]: Ce(u2, 1),
                    [r_unorderedList]: Ce(u2, 2),
                    [r_newlineCoalescer]: {
                      match: De(b),
                      order: 3,
                      parse: Ze,
                    ...
                    [r_paragraph]: {
                      ...
                      parse: Ge,
                      render: (e2, t2, n3) =>
                        u2('p', { key: n3.key }, t2(e2.children, n3)),
                    },
                    [r_ref]: {
                      match: Re(P),
                      order: 0,
                      parse: (e2) => (
                        (V2[e2[1]] = { target: e2[2], title: e2[4] }),
                        {}
                      ),
                      render: qe,
                    },
                    ...
                    [r_refLink]: {
                      ...
                      render: (e2, t2, n3) =>
                        V2[e2.ref]
                          ...
                          : u2('span', { key: n3.key }, e2.fallbackChildren),
                    },
                    [r_table]: {
                      match: De(H),
                      order: 1,
                    ...
                    [r_text]: {
                      ...
                      order: 4,
                      parse: (e2) => ({
                        text: e2[0].replace(T, (e3, t2) =>
                          i2.namedCodesToUnicode[t2]
                            ? i2.namedCodesToUnicode[t2]
                            : e3
                        ),
                      }),
                    ...
                    [r_textBolded]: {
                      ...
                      render: (e2, t2, n3) =>
                        u2('strong', { key: n3.key }, t2(e2.children, n3)),
                    },
                    [r_textEmphasized]: {
                      match: Ie(K),
                      order: 3,
                      parse: (e2, t2, n3) => ({ children: t2(e2[2], n3) }),
                      render: (e2, t2, n3) =>
                        u2('em', { key: n3.key }, t2(e2.children, n3)),
                    },
                    [r_textEscaped]: {
                      match: Ie(te),
                      order: 1,
                      parse: (e2) => ({ text: e2[1], type: r_text }),
                    },
                    [r_textMarked]: {
                      match: Ie(Y),
                      order: 3,
                      parse: Ge,
                      render: (e2, t2, n3) =>
                        u2('mark', { key: n3.key }, t2(e2.children, n3)),
                    },
                    [r_textStrikethroughed]: {
                      match: Ie(ee),
                      order: 3,
                      parse: Ge,
                      render: (e2, t2, n3) =>
                        u2('del', { key: n3.key }, t2(e2.children, n3)),
                    },
                  }
                !0 === i2.disableParsingRawHTML &&
                  (delete X2[r_htmlBlock], delete X2[r_htmlSelfClosing])
                let oe2 = (function (e2) {
                      ...
                      for (i3.prevCapture = i3.prevCapture || ''; r2; ) {
                        ...
                        for (; d2 < t2.length; ) {
                          ...
                          if (u3) {
                            ;((s2 = u3[0]),
                              (i3.prevCapture += s2),
                              (r2 = r2.substring(s2.length)),
                              (o2 = l2.parse(u3, n3, i3)),
                              null == o2.type && (o2.type = c2),
                              a2.push(o2))
                            break
                          }
                          d2++
          ...
          FormInput = (0, theming.I4)(components.lV.Input)(({ readOnly }) => ({
            opacity: readOnly ? 0.5 : 1,
          })),
          FlexSpaced = theming.I4.div(({ theme }) => ({
            flex: 1,
            display: 'flex',
            input: {
              marginLeft: 10,
          ...
          Wrapper4 = theming.I4.label({ display: 'flex' }),
          FormInput2 = (0, theming.I4)(components.lV.Input)(({ readOnly }) => ({
            opacity: readOnly ? 0.5 : 1,
          })),
          selectedKey = (value2, options) => {
            let entry =
              options &&
              Object.entries(options).find(([_key, val]) => val === value2)
          ...
          Text = theming.I4.span({
            '[aria-readonly=true] &': { opacity: 0.5 },
          }),
          Label3 = theming.I4.label({
            lineHeight: '20px',
            alignItems: 'center',
            marginBottom: 8,
            '&:last-child': { marginBottom: 0 },
          ...
          CheckboxControl = ({
            ...
            let initial = selectedKeys(value2 || [], options),
              [selected, setSelected] = (0, react.useState)(initial),
            ...
            let controlId = (0, chunk_SPFYY5GD.ZA)(name)
            return react.createElement(
              Wrapper5,
          ...
          Text2 = theming.I4.span({
            '[aria-readonly=true] &': { opacity: 0.5 },
          }),
          Label4 = theming.I4.label({
            lineHeight: '20px',
            alignItems: 'center',
            marginBottom: 8,
            '&:last-child': { marginBottom: 0 },
          ...
          RadioControl = ({
            ...
            let selection = selectedKey(value2, options),
              controlId = (0, chunk_SPFYY5GD.ZA)(name),
              readonly = !!argType?.table?.readonly
            return react.createElement(
              Wrapper6,
              { 'aria-readonly': readonly, isInline },
          ...
          OptionsSelect = theming.I4.select(
            {
              appearance: 'none',
              border: '0 none',
              boxSizing: 'inherit',
          ...
          SelectWrapper = theming.I4.span(({ theme }) => ({
            display: 'inline-block',
            lineHeight: 'normal',
            overflow: 'hidden',
            position: 'relative',
          ...
          SingleSelect = ({
            ...
            let selection = selectedKey(value2, options) || 'Choose option...',
              controlId = (0, chunk_SPFYY5GD.ZA)(name),
              readonly = !!argType?.table?.readonly
            return react.createElement(
              SelectWrapper,
              null,
              react.createElement(dist.abt, null),
              react.createElement(
                OptionsSelect,
                {
                  disabled: readonly,
          ...
          OptionsControl = (props) => {
            let { type = 'select', labels, argType } = props,
              normalized = {
                ...
                argType,
                options: argType
                  ? normalizeOptions(argType.options, labels)
                  : {},
        ...
        var JsonArray = class extends react.Component {
          ...
          handleRemoveItem(index) {
            return () => {
              let { beforeRemoveAction, logger: logger4 } = this.props,
                ...
                oldValue = data[index]
              ;(beforeRemoveAction || Promise.resolve.bind(Promise))(
                index,
                keyPath,
                deep,
                oldValue
          ...
          handleAddValueAdd({ key, newValue }) {
            ...
            ;(beforeAddAction || Promise.resolve.bind(Promise))(
              key,
              keyPath,
              deep,
              newValue
          ...
          handleEditValue({ key, value: value2 }) {
            return new Promise((resolve, reject) => {
              let { beforeUpdateAction } = this.props,
                { data, keyPath, nextDeep: deep } = this.state,
                oldValue = data[key]
              ;(beforeUpdateAction || Promise.resolve.bind(Promise))(
                key,
                keyPath,
                deep,
                oldValue,
          ...
          renderCollapsed() {
            let { name, data, keyPath, deep } = this.state,
              ...
              removeItemButton =
                minusMenuElement &&
                (0, react.cloneElement)(minusMenuElement, {
          ...
          renderNotCollapsed() {
            let { name, data, keyPath, deep, addFormVisible, nextDeep } =
                this.state,
              {
                isCollapsed,
                handleRemove,
              ...
              addItemButton =
                plusMenuElement &&
                (0, react.cloneElement)(plusMenuElement, {
            ...
            return react.createElement(
              ...
              !isReadOnly &&
                ...
                react.createElement(
                  ...
                  react.createElement(JsonAddValue, {
        ...
        var JsonFunctionValue = class extends react.Component {
          ...
          handleEdit() {
            ...
            let newValue = onSubmitValueParser(
              ...
              result = { value: newValue, key: name }
            ...
            if (editEnabled && !resultOnlyResult) {
              let textareaElement = textareaElementGenerator(
                ...
                editButtonElementLayout =
                  editButtonElement &&
                  (0, react.cloneElement)(editButtonElement, {
        ...
        var JsonNode = class extends react.Component {
          ...
          render() {
            ...
            switch (dataType) {
              case 'Error':
                return react.createElement(JsonObject, {
                  data,
                  name,
                  isCollapsed,
                  keyPath,
              ...
              case 'String':
                return react.createElement(JsonValue, {
                  name,
                  value: `"${data}"`,
                  originalValue: data,
                  keyPath,
              ...
              case 'Function':
                return react.createElement(JsonFunctionValue, {
                  name,
                  value: data.toString(),
                  originalValue: data,
                  keyPath,
        ...
        var object = {
          ...
          JsonTree = class extends react.Component {
            constructor(props) {
              ;(super(props),
        ...
        var { window: globalWindow2 } = globalThis,
          ...
          ButtonInline = theming.I4.button(({ theme, primary }) => ({
            border: 0,
            height: 20,
            margin: 1,
            borderRadius: 4,
          ...
          ActionAddIcon = (0, theming.I4)(dist.REV)(({ theme, disabled }) => ({
            display: 'inline-block',
          ...
          ActionSubstractIcon = (0, theming.I4)(dist.Qpb)(
            ({ theme, disabled }) => ({
              display: 'inline-block',
              verticalAlign: 'middle',
              width: 15,
          ...
          Input = theming.I4.input(({ theme, placeholder }) => ({
            outline: 0,
          ...
          RawButton = (0, theming.I4)(components.K0)(({ theme }) => ({
            position: 'absolute',
            zIndex: 2,
            top: 2,
            right: 2,
          ...
          RawInput = (0, theming.I4)(components.lV.Textarea)(({ theme }) => ({
            flex: 1,
            padding: '7px 6px',
            fontFamily: theme.typography.fonts.mono,
            fontSize: '12px',
          ...
          ObjectControl = ({ name, value: value2, onChange, argType }) => {
            let theme = (0, theming.DP)(),
              data = (0, react.useMemo)(
                () => value2 && (0, chunk_SPFYY5GD.mg)(value2),
                [value2]
              ),
              hasData = null != data,
              [showRaw, setShowRaw] = (0, react.useState)(!hasData),
              [parseError, setParseError] = (0, react.useState)(null),
              readonly = !!argType?.table?.readonly,
              ...
              [forceVisible, setForceVisible] = (0, react.useState)(!1),
            ...
            let rawJSONForm = react.createElement(RawInput, {
              ...
              isObjectOrArray =
                ...
                ('object' == typeof value2 && value2?.constructor === Object)
            return react.createElement(
              Wrapper7,
              ...
              isObjectOrArray &&
                react.createElement(
                  ...
                  showRaw
                    ? react.createElement(dist.dbI, null)
                    : react.createElement(dist.bMW, null),
              ...
              showRaw
                ...
                : react.createElement(JsonTree, {
                    ...
                    plusMenuElement: react.createElement(ActionAddIcon, null),
                    minusMenuElement: react.createElement(
                      ActionSubstractIcon,
                      null
                    ),
                    inputElement: (_2, __, ___, key) =>
                      key
                        ? react.createElement(Input, {
                            onFocus: selectValue,
          ...
          RangeCurrentAndMaxLabel = (0, theming.I4)(RangeLabel)(
          ...
          RangeWrapper = theming.I4.div({
            display: 'flex',
            alignItems: 'center',
            width: '100%',
          })
        var Wrapper8 = theming.I4.label({ display: 'flex' }),
          MaxLength = theming.I4.div(({ isMaxed }) => ({
            marginLeft: '0.75rem',
            paddingTop: '0.35rem',
            color: isMaxed ? 'red' : void 0,
          })),
          FileInput = (0, theming.I4)(components.lV.Input)({ padding: 10 })
        var LazyColorControl = (0, react.lazy)(() =>
            __webpack_require__
              .e(6630)
              .then(
                __webpack_require__.bind(
                  __webpack_require__,
                  '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/Color-AVL7NMMY.mjs'
                )
              )
          ),
          Controls2 = {
            ...
            boolean: ({
              ...
              return react.createElement(
                ...
                react.createElement('span', { 'aria-hidden': 'true' }, 'False'),
                react.createElement('span', { 'aria-hidden': 'true' }, 'True')
              )
            },
            color: (props) =>
              react.createElement(
            ...
            date: ({
              ...
              let [valid, setValid] = (0, react.useState)(!0),
            ...
            number: ({
              ...
              return (
                ...
                (0, react.useEffect)(() => {
                  let newInputValue = 'number' == typeof value2 ? value2 : ''
            ...
            text: ({
              ...
              return react.createElement(
                Wrapper8,
                null,
                react.createElement(components.lV.Textarea, {
                  id: (0, chunk_SPFYY5GD.ZA)(name),
                  maxLength,
                  onChange: (event) => {
            ...
            file: ({
              ...
              let inputElement = (0, react.useRef)(null),
          ...
          NoControl = () => react.createElement(react.Fragment, null, '-'),
          ArgControl = ({ row, arg, updateArgs, isHovered }) => {
            let { key, control } = row,
              [isFocused, setFocused] = (0, react.useState)(!1),
              [boxedValue, setBoxedValue] = (0, react.useState)({ value: arg })
            ;(0, react.useEffect)(() => {
            ...
            let onChange = (0, react.useCallback)(
              ...
              onBlur = (0, react.useCallback)(() => setFocused(!1), []),
              onFocus = (0, react.useCallback)(() => setFocused(!0), [])
            if (!control || control.disable) {
              return isHovered &&
                !0 !== control?.disable &&
                'function' !== row?.type?.name
                ? react.createElement(
                    components.N_,
                    {
                ...
                : react.createElement(NoControl, null)
            }
            let props = {
                name: key,
                argType: row,
          ...
          ArgJsDoc = ({ tags }) => {
            let params = (tags.params || []).filter((x2) => x2.description),
              ...
              hasDisplayableReturns =
                null != tags.returns && null != tags.returns.description
                        ...
                        params.map((x2) =>
                          react.createElement(
                            ...
                            react.createElement(
                              'td',
                              null,
                              react.createElement('code', null, x2.name)
                            ),
                            react.createElement('td', null, x2.description)
                          )
                        ),
                      hasDisplayableReturns &&
                        react.createElement(
          ...
          import_memoizerific = (0, chunk_QUZPS4B6.f1)(require_memoizerific()),
          Summary = theming.I4.div(({ isExpanded }) => ({
            display: 'flex',
          ...
          Text3 = theming.I4.span(components.zb, ({ theme, simple = !1 }) => ({
            flex: '0 0 auto',
            fontFamily: theme.typography.fonts.mono,
            fontSize: theme.typography.size.s1,
            wordBreak: 'break-word',
          ...
          ExpandButton = theming.I4.button(({ theme }) => ({
            fontFamily: theme.typography.fonts.mono,
            color: theme.color.secondary,
            marginBottom: '4px',
            background: 'none',
          ...
          Expandable = theming.I4.div(components.zb, ({ theme }) => ({
            fontFamily: theme.typography.fonts.mono,
            color: theme.color.secondary,
            fontSize: theme.typography.size.s1,
            margin: 0,
          ...
          Detail = theming.I4.div(({ theme, width }) => ({
            width,
            minWidth: 200,
            maxWidth: 800,
            padding: 15,
          ...
          ChevronUpIcon = (0, theming.I4)(dist.tN5)({ marginLeft: 4 }),
          ChevronDownIcon = (0, theming.I4)(dist.abt)({ marginLeft: 4 }),
          EmptyArg = () => react.createElement('span', null, '-'),
          ArgText = ({ text, simple }) =>
            react.createElement(Text3, { simple }, text),
          ...
          ArgSummary = ({ value: value2, initialExpandedArgs }) => {
            ...
            if (null == detail) {
              ...
              let summaryItems = ((summary) => {
                  ...
                  return (0, chunk_SPFYY5GD.sb)(summaryItems)
                })(summaryAsString),
          ...
          ArgValue = ({ value: value2, initialExpandedArgs }) =>
            null == value2
              ...
              : react.createElement(ArgSummary, {
                  value: value2,
                  initialExpandedArgs,
                }),
          Name = theming.I4.span({ fontWeight: 'bold' }),
          Required = theming.I4.span(({ theme }) => ({
            color: theme.color.negative,
            fontFamily: theme.typography.fonts.mono,
            cursor: 'help',
          })),
          Description = theming.I4.div(({ theme }) => ({
            '&&': {
              p: { margin: '0 0 10px 0' },
              a: { color: theme.color.secondary },
            },
            code: {
              ...(0, components.zb)({ theme }),
              fontSize: 12,
              fontFamily: theme.typography.fonts.mono,
            },
          ...
          Type = theming.I4.div(({ theme, hasDescription }) => ({
            color:
              'light' === theme.base
                ? curriedTransparentize$1(0.1, theme.color.defaultText)
                : curriedTransparentize$1(0.2, theme.color.defaultText),
          ...
          TypeWithJsDoc = theming.I4.div(({ theme, hasDescription }) => ({
            color:
              'light' === theme.base
                ? curriedTransparentize$1(0.1, theme.color.defaultText)
                : curriedTransparentize$1(0.2, theme.color.defaultText),
          ...
          StyledTd = theming.I4.td(({ expandable }) => ({
            paddingLeft: expandable ? '40px !important' : '20px !important',
          })),
          ArgRow = (props) => {
            let [isHovered, setIsHovered] = (0, react.useState)(!1),
              ...
              type =
                table.type ||
                ((value2 = row.type) && {
                  summary: 'string' == typeof value2 ? value2 : value2.name,
                }),
            ...
            return react.createElement(
              ...
              updateArgs
                ? react.createElement(
                    'td',
                    null,
                    react.createElement(ArgControl, { ...props, isHovered })
                  )
                : null
            )
          },
          Wrapper9 = theming.I4.div(({ inAddonPanel, theme }) => ({
            ...
            return (
              ...
              isLoading
                ...
                : react.createElement(
                    Wrapper9,
                    { inAddonPanel },
                    react.createElement(components.Q2, {
                      title: inAddonPanel
                        ...
                        inAddonPanel &&
                          react.createElement(
                            ...
                            react.createElement(
                              ...
                              react.createElement(dist.pyG, null),
                              ' Read docs'
                            )
                          ),
                        !inAddonPanel &&
          ...
          ExpanderIconDown = (0, theming.I4)(dist.D3D)(({ theme }) => ({
            marginRight: 8,
            marginLeft: -10,
            marginTop: -2,
            height: 12,
          ...
          ExpanderIconRight = (0, theming.I4)(dist.vKP)(({ theme }) => ({
            marginRight: 8,
            marginLeft: -10,
            marginTop: -2,
            height: 12,
          ...
          FlexWrapper = theming.I4.span(({ theme }) => ({
            display: 'flex',
            lineHeight: '20px',
            alignItems: 'center',
          })),
          Section = theming.I4.td(({ theme }) => ({
            position: 'relative',
          ...
          Subsection = theming.I4.td(({ theme }) => ({
            position: 'relative',
            fontWeight: theme.typography.weight.bold,
            fontSize: theme.typography.size.s2 - 1,
            background: theme.background.app,
          })),
          StyledTd2 = theming.I4.td({ position: 'relative' }),
          StyledTr = theming.I4.tr(({ theme }) => ({
            '&:hover > td': {
          ...
          ClickIntercept = theming.I4.button({
            background: 'none',
            border: 'none',
            padding: '0',
            font: 'inherit',
          ...
          SectionRow = ({
            ...
            let [expanded, setExpanded] = (0, react.useState)(initialExpanded),
              ...
              react.createElement(
                ...
                react.createElement(
                  ...
                  react.createElement(
                    ...
                    null,
                    expanded
                      ? react.createElement(ExpanderIconDown, null)
                      : react.createElement(ExpanderIconRight, null),
                    label
                  )
                ),
                react.createElement(
          ...
          TableWrapper = theming.I4.div(({ theme }) => ({
            width: '100%',
            borderSpacing: 0,
            color: theme.color.defaultText,
          })),
          Row = theming.I4.div(({ theme }) => ({
            display: 'flex',
            borderBottom: `1px solid ${theme.appBorderColor}`,
            '&:last-child': { borderBottom: 0 },
          })),
          Column = theming.I4.div(({ position, theme }) => {
            let baseStyles = {
              display: 'flex',
              flexDirection: 'column',
              gap: 5,
          ...
          SkeletonText = theming.I4.div(({ theme, width, height }) => ({
            animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
            background: theme.appBorderColor,
            width: width || '100%',
            height: height || 16,
            ...
            react.createElement(
              ...
              react.createElement(
                ...
                react.createElement(
                  Column,
                  { position: 'first' },
                  react.createElement(SkeletonText, { width: '60%' })
                ),
                react.createElement(
                  Column,
                  { position: 'second' },
                  react.createElement(SkeletonText, { width: '30%' })
                ),
                react.createElement(
                  Column,
                  { position: 'third' },
              ...
              react.createElement(
                ...
                react.createElement(
                  Column,
                  { position: 'second' },
                  react.createElement(SkeletonText, { width: '80%' }),
                  react.createElement(SkeletonText, { width: '30%' })
                ),
                react.createElement(
                  Column,
          ...
          TableWrapper2 = theming.I4.table(
          ...
          StyledIconButton = (0, theming.I4)(components.K0)(({ theme }) => ({
            margin: '-4px -12px -4px 0',
          })),
          ControlHeadingWrapper = theming.I4.span({
            display: 'flex',
          ...
          sortFns = {
            ...
            requiredFirst: (a2, b2) =>
              +!!b2.type?.required - +!!a2.type?.required ||
          ...
          ArgsTable = (props) => {
            ...
            let { rows, args, globals } =
                'rows' in props
                  ? props
                  : { rows: void 0, args: void 0, globals: void 0 },
              groups = ((rows, sort) => {
                let sections = {
                  ungrouped: [],
                ...
                return {
                  ungrouped: sortFn
                    ? sections.ungrouped.sort(sortFn)
                    : sections.ungrouped,
                ...
                (0, chunk_SPFYY5GD.fN)(
                  ...
                  (row) =>
                    ...
                    ((row, args, globals) => {
                      try {
                        return (0, csf.hX)(row, args, globals)
                      } catch (err) {
                        return (
              ...
              hasNoUngrouped = 0 === groups.ungrouped.length,
              hasNoSections = 0 === Object.entries(groups.sections).length,
        ...
        globalThis &&
          ...
          ((globalThis.__DOCS_CONTEXT__ = (0, react.createContext)(null)),
        ...
        var require_es_object_atoms = __commonJS2({
            ...
            'node_modules/.pnpm/has-symbols@1.1.0/node_modules/has-symbols/shams.js'(
              ...
              module.exports = function () {
                ...
                if (
                  ...
                  return !1
                for (var _2 in ((obj[sym] = 42), obj)) return !1
                if (
          ...
          require_Reflect_getPrototypeOf = __commonJS2({
            'node_modules/.pnpm/get-proto@1.0.1/node_modules/get-proto/Reflect.getPrototypeOf.js'(
              ...
              module.exports =
                (typeof Reflect < 'u' && Reflect.getPrototypeOf) || null
            },
          }),
          ...
          require_implementation = __commonJS2({
            'node_modules/.pnpm/function-bind@1.1.2/node_modules/function-bind/implementation.js'(
              ...
              module.exports = function (that) {
                ...
                for (
                  var bound,
                    args = (function (arrLike, offset) {
                      for (
                        var arr = [], i2 = offset || 0, j2 = 0;
                        i2 < arrLike.length;
                        i2 += 1, j2 += 1
                      )
                        arr[j2] = arrLike[i2]
          ...
          require_call_bind_apply_helpers = __commonJS2({
            'node_modules/.pnpm/call-bind-apply-helpers@1.0.2/node_modules/call-bind-apply-helpers/index.js'(
              ...
              module.exports = function (args) {
                if (args.length < 1 || 'function' != typeof args[0])
          ...
          require_get = __commonJS2({
            'node_modules/.pnpm/dunder-proto@1.0.1/node_modules/dunder-proto/get.js'(
              ...
              var hasProtoAccessor,
                callBind = require_call_bind_apply_helpers(),
                gOPD = require_gopd()
              try {
              ...
              var desc =
                  !!hasProtoAccessor &&
                  gOPD &&
                  gOPD(Object.prototype, '__proto__'),
                $Object = Object,
                $getPrototypeOf = $Object.getPrototypeOf
              module.exports =
                desc && 'function' == typeof desc.get
                  ? callBind([desc.get])
                  : 'function' == typeof $getPrototypeOf &&
                    function (value2) {
                      return $getPrototypeOf(
                        null == value2 ? value2 : $Object(value2)
                      )
                    }
            },
          }),
              ...
              module.exports = reflectGetProto
                ...
                : originalGetProto
                  ? function (O2) {
                      if (
                        !O2 ||
                        ('object' != typeof O2 && 'function' != typeof O2)
                      )
            ...
            'node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js'(
              ...
              var $Object = require_es_object_atoms(),
                ...
                INTRINSICS = {
                  ...
                  '%BigInt64Array%':
                    typeof BigInt64Array > 'u' ? undefined : BigInt64Array,
                  '%BigUint64Array%':
                    typeof BigUint64Array > 'u' ? undefined : BigUint64Array,
                  '%Boolean%': Boolean,
                  ...
                  '%EvalError%': $EvalError,
                  '%Float16Array%':
                    typeof Float16Array > 'u' ? undefined : Float16Array,
                  '%Float32Array%':
                ...
                ? (($symToStr = callBound('Symbol.prototype.toString')),
                  ...
                  (isSymbolObject = function (value2) {
                    return (
                      ...
                      isSymString($symToStr(value2))
                    )
                  }),
                  (module.exports = function (value2) {
                    if ('symbol' == typeof value2) return !0
                    if (
                      !value2 ||
                      'object' != typeof value2 ||
                      '[object Symbol]' !== $toString(value2)
                    )
                      return !1
                    try {
        ...
        var getRawTag_default = function getRawTag(value2) {
            var isOwn = blocks_hasOwnProperty.call(value2, symToStringTag),
        ...
        var objectToString_default = function objectToString(value2) {
            return nativeObjectToString2.call(value2)
          },
          symToStringTag2 = Symbol_default ? Symbol_default.toStringTag : void 0
        var baseGetTag_default = function baseGetTag(value2) {
            return null == value2
              ? void 0 === value2
                ? '[object Undefined]'
                : '[object Null]'
        ...
        var isObject_default = function isObject2(value2) {
          var type = typeof value2
          return null != value2 && ('object' == type || 'function' == type)
        }
        var uid,
          isFunction_default = function isFunction(value2) {
        ...
        var baseIsNative_default = function baseIsNative(value2) {
          return (
            !(!isObject_default(value2) || isMasked_default(value2)) &&
            (isFunction_default(value2) ? reIsNative : reIsHostCtor).test(
              toSource_default(value2)
            )
          )
        }
        var getValue_default = function getValue(object2, key) {
          return object2?.[key]
        }
        var getNative_default = function getNative(object2, key) {
          var value2 = getValue_default(object2, key)
          return baseIsNative_default(value2) ? value2 : void 0
        }
        var eq_default = function eq(value2, other) {
        ...
        var hashDelete_default = function hashDelete(key) {
            var result = this.has(key) && delete this.__data__[key]
            return ((this.size -= result ? 1 : 0), result)
          },
          hasOwnProperty3 = Object.prototype.hasOwnProperty
        var hashGet_default = function hashGet(key) {
        ...
        var hashHas_default = function hashHas(key) {
          var data = this.__data__
          return nativeCreate_default
            ? void 0 !== data[key]
            : hasOwnProperty4.call(data, key)
        }
        var hashSet_default = function hashSet(key, value2) {
          var data = this.__data__
          return (
            (this.size += this.has(key) ? 0 : 1),
            (data[key] =
              nativeCreate_default && void 0 === value2
        ...
        var assocIndexOf_default = function assocIndexOf(array2, key) {
            for (var length = array2.length; length--; )
              if (eq_default(array2[length][0], key)) return length
            return -1
          },
          splice = Array.prototype.splice
        var listCacheDelete_default = function listCacheDelete(key) {
          var data = this.__data__,
        ...
        var listCacheGet_default = function listCacheGet(key) {
          var data = this.__data__,
            index = assocIndexOf_default(data, key)
          return index < 0 ? void 0 : data[index][1]
        }
        var listCacheHas_default = function listCacheHas(key) {
          return assocIndexOf_default(this.__data__, key) > -1
        }
        var listCacheSet_default = function listCacheSet(key, value2) {
          var data = this.__data__,
            index = assocIndexOf_default(data, key)
          return (
            index < 0
              ? (++this.size, data.push([key, value2]))
              : (data[index][1] = value2),
            this
          )
        }
        ...
        var isKeyable_default = function isKeyable(value2) {
          var type = typeof value2
          return 'string' == type ||
            'number' == type ||
            'symbol' == type ||
        ...
        var getMapData_default = function getMapData(map, key) {
          var data = map.__data__
          return isKeyable_default(key)
            ? data['string' == typeof key ? 'string' : 'hash']
            : data.map
        }
        var mapCacheDelete_default = function mapCacheDelete(key) {
          var result = getMapData_default(this, key).delete(key)
          return ((this.size -= result ? 1 : 0), result)
        }
        var mapCacheGet_default = function mapCacheGet(key) {
          return getMapData_default(this, key).get(key)
        }
        var mapCacheHas_default = function mapCacheHas(key) {
          return getMapData_default(this, key).has(key)
        }
        var mapCacheSet_default = function mapCacheSet(key, value2) {
        ...
        var isObject3 = function isObject(val) {
            return (
        ...
        function convertUnconventionalData(data) {
          ...
          return (
            typeof Event < 'u' &&
              ...
              ((result = (function extractEventHiddenProperties(event) {
                let rebuildEvent = eventProperties
                  .filter((value2) => void 0 !== event[value2])
                  .reduce(
                    (acc, value2) => ((acc[value2] = event[value2]), acc),
                    {}
                  )
                if (event instanceof CustomEvent)
                  for (let value2 of customEventSpecificProperties.filter(
                    (value22) => void 0 !== event[value22]
                  ))
                ...
                return function (key, value2) {
                  try {
                    ...
                    if (
                      ...
                      'Object' !== value2.constructor.name &&
                      !Array.isArray(value2)
                    ) {
              ...
              (0, react.useEffect)(() => {
                let handleSnippetRendered = (
                  ...
                  let {
                      ...
                      : idOrEvent,
                    hash = args ? argsHash(args) : '--unknown--'
                  setSources((current) => ({
                    ...current,
                    [id]: {
                      ...current[id],
                      [hash]: { code: source || '', format: format3 },
                    },
                  }))
                }
                return (
                  channel.on(docs_tools.Op, handleSnippetRendered),
                  () => channel.off(docs_tools.Op, handleSnippetRendered)
                )
              }, []),
              react.createElement(
        ...
        var useCode = ({
            ...
            let parameters = storyContext.parameters ?? {},
              { __isArgsStory: isArgsStory } = parameters,
              sourceParameters = parameters.docs?.source || {},
              type =
                typeFromProps || sourceParameters.type || docs_tools.Y1.AUTO,
              code =
                type === docs_tools.Y1.DYNAMIC ||
                (type === docs_tools.Y1.AUTO && snippet && isArgsStory)
                  ? snippet
                  : sourceParameters.originalSource || '',
              transformer = transformFromProps ?? sourceParameters.transform,
              transformedCode = transformer
                ? (function useTransformCode(source, transform, storyContext) {
                    let [transformedCode, setTransformedCode] = (0,
                      react.useState)('Transforming...'),
                    ...
                    return (
                      ...
                      'object' == typeof transformed &&
                      'function' == typeof transformed.then
                        ? transformedCode
                        : transformed
                    )
                  })(code, transformer, storyContext)
                : code
            return void 0 !== sourceParameters.code
              ? sourceParameters.code
              : transformedCode
          },
          useSourceProps = (props, docsContext, sourceContext) => {
            let { of } = props,
              story = (0, react.useMemo)(() => {
              ...
              source = story
                ? ((storyId, args, sourceContext) => {
                    let { sources } = sourceContext,
                      sourceMap = sources?.[storyId]
                    return (
                      sourceMap?.[argsHash(args)] ||
                      sourceMap?.['--unknown--'] || { code: '' }
                    )
                  })(story.id, argsForSource, sourceContext)
                : null,
            ...
            return props.code || story
              ? props.code
                ? { code: props.code, format: format3, language, dark }
                : ((format3 = source?.format ?? !0),
                  { code: transformedCode, format: format3, language, dark })
        ...
        var Story2 = (props = { __forceInitialArgs: !1, __primary: !1 }) => {
            ...
            let storyProps = ((props, story, context) => {
              ...
              if (props.inline ?? storyParameters.inline)
                return {
                  story,
                  inline: !0,
          ...
          Canvas = (props) => {
            let docsContext = (0, react.useContext)(DocsContext),
              sourceContext = (0, react.useContext)(SourceContext),
              { of, source } = props
            if ('of' in props && void 0 === of)
              throw new Error(
                'Unexpected `of={undefined}`, did you mistype a CSF file reference?'
            ...
            let { story } = useOf(of || 'story', ['story']),
              ...
              sourceState =
                ...
                'hidden',
              className =
                props.className ?? story.parameters.docs?.canvas?.className,
              inline =
                props.story?.inline ??
                story.parameters?.docs?.story?.inline ??
                !1
            return react.createElement(
              Preview,
              {
                withSource: 'none' === sourceState ? void 0 : sourceProps,
                isExpanded: 'shown' === sourceState,
                withToolbar,
                additionalActions,
                className,
                layout,
          ...
          useArgsIfDefined = (story, context) => {
            let storyContext = story
              ...
              [args, setArgs] = (0, react.useState)(storyContext.args)
            ;(0, react.useEffect)(() => {
        ...
        var Controls3 = (props) => {
            ...
            let context = (0, react.useContext)(DocsContext),
              ...
              [args, updateArgs, resetArgs] = ((story, context) => {
        ...
        var DescriptionType2,
          ...
          AnchorMdx = (props) => {
            ...
            return !href || '_blank' === target || /^https?:\/\//.test(href)
              ? react.createElement(A2, { ...props })
              : href.startsWith('#')
                ? react.createElement(AnchorInPage, { hash: href }, children)
                : react.createElement(
                    A2,
                    {
                      href,
          ...
          OcticonHeaders = SUPPORTED_MDX_HEADERS.reduce(
            (acc, headerType) => ({
              ...acc,
              [headerType]: (0, theming.I4)(headerType)({
                '& svg': {
                  position: 'relative',
                  top: '-0.1em',
                  visibility: 'hidden',
                ...
                OcticonAnchor,
                {
                  ...
                  onClick: (event) => {
                    document2.getElementById(id) &&
                      blocks_navigate(context, hash)
                  },
                },
                react.createElement(dist.qYV, null)
              ),
              children
            )
          },
          ...
          HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(
            (acc, headerType) => ({
              ...acc,
              [headerType]: (props) =>
                react.createElement(HeaderMdx, { as: headerType, ...props }),
            }),
            {}
          ),
          Markdown = (props) => {
      ...
      `)
            return react.createElement(index_modern_default, {
              ...props,
              options: {
                forceBlock: !0,
                overrides: {
          ...
          { document: document3, window: globalWindow3 } = globalThis,
          DocsContainer = ({ context, theme, children }) => {
            let toc
            try {
              toc = context.resolveOf('meta', ['meta']).preparedMeta.parameters
                ?.docs?.toc
            } catch {
        ...
        var slugs = new (class {
            ...
            slug(value2, maintainCase) {
              let self2 = this,
                result = (function slug(value2, maintainCase) {
                  return 'string' != typeof value2
                    ? ''
                    : (maintainCase || (value2 = value2.toLowerCase()),
                      value2.replace(regex, '').replace(/ /g, '-'))
                })(value2, !0 === maintainCase),
                originalSlug = result
            ...
            return react.createElement(
              ...
              expanded &&
                react.createElement(
                  react.Fragment,
                  null,
                  react.createElement(Subheading, null, story.name),
                  react.createElement(DescriptionContainer, { of })
                ),
          ...
          Primary = (props) => {
            ...
            let { csfFile } = useOf(of || 'meta', ['meta']),
              primaryStory = (0, react.useContext)(
                DocsContext
              ).componentStoriesFromCSFFile(csfFile)[0]
            return primaryStory
              ? react.createElement(DocsStory, {
          ...
          DocsPage = () => {
            ...
            return react.createElement(
              react.Fragment,
              null,
              react.createElement(Title3, null),
              react.createElement(Subtitle2, null),
              react.createElement(DescriptionContainer, { of: 'meta' }),
              isSingleStory
                ? react.createElement(DescriptionContainer, { of: 'story' })
                : null,
              react.createElement(Primary, null),
              react.createElement(Controls3, null),
              isSingleStory ? null : react.createElement(Stories, null)
            )
          }
                ...
                return new Promise((resolve, reject) => {
                  __webpack_require__
                    ...
                    .then(
                      __webpack_require__.bind(
                        __webpack_require__,
                        '../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@19.1.8_react@19.1.0/node_modules/@mdx-js/react/index.js'
                      )
                    )
                    .then(({ MDXProvider }) =>
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var __create = Object.create,
          ...
          __require = __webpack_require__(
            '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist sync recursive'
          ),
          __commonJS = (cb, mod) =>
            function () {
              return (
    ...
    '../../node_modules/.pnpm/@storybook+addon-docs@9.0.18_@types+react@19.1.8_storybook@9.0.18_@testing-library+dom@10.4.0_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/chunk-SPFYY5GD.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function times(n, getValue) {
          ...
          for (let i = 0; i < n; i++)
            result[i] = 'function' == typeof getValue ? getValue(i) : i
          return result
        }
              ...
              return isArrayLike(object)
                ...
                : (function isPrototype(value) {
                  ...
                  ? (function prototypeKeysIn(object) {
                      return keysInImpl(object).filter(
                        (key) => 'constructor' !== key
                      )
                    })(object)
                  : keysInImpl(object)
...
//# sourceMappingURL=9597.cf82c8eb.iframe.bundle.js.map
