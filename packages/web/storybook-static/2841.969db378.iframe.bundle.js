  ...
  [2841],
  {
    '../../node_modules/.pnpm/@emotion+is-prop-valid@1.3.1/node_modules/@emotion/is-prop-valid/dist/emotion-is-prop-valid.esm.js':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, { A: () => isPropValid })
        var reactPropsRegex =
    ...
    '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { xQ: () => usePresence })
        var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
            '../../node_modules/.pnpm/next@15.2.4_@babel+core@7.28.0_@opentelemetry+api@1.9.0_@playwright+test@1.54.1_react-d_866e0ebb5cad13c7ae73d64ed145106f/node_modules/next/dist/compiled/react/index.js'
          ),
          _context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
        ...
        function usePresence(subscribe = !0) {
          const context = (0, react__WEBPACK_IMPORTED_MODULE_0__.useContext)(
            _context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_1__.t
          )
    ...
    '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/context/PresenceContext.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { t: () => PresenceContext })
    ...
    '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { P: () => motion })
        ...
        function parseValueFromTransform(transform, name) {
          ...
          const valueParser = parsers[name],
            values = match[1].split(',').map(convertTransformToNumber)
          return 'function' == typeof valueParser
            ? valueParser(values)
            : values[valueParser]
        }
        ...
        const checkStringStartsWith = (token) => (key) =>
          ...
          isCSSVariableToken = (value) =>
            !!startsAsVariableToken(value) &&
            singleCssVariableRegex.test(value.split('/*')[0].trim()),
        ...
        const positionalKeys = new Set([
          ...
          clamp = (min, max, v) => (v > max ? max : v < min ? min : v),
          number = {
        ...
        function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
          ...
          const state = { delta: 0, timestamp: 0, isProcessing: !1 },
            ...
            steps = stepsOrder.reduce(
              (acc, key) => (
                (acc[key] = (function createRenderStep(runNextFrame, stepName) {
                  ...
                  const step = {
                    schedule: (callback, keepAlive = !1, immediate = !1) => {
                      const queue =
                        immediate && isProcessing ? thisFrame : nextFrame
                      return (
                        keepAlive && toKeepAlive.add(callback),
                        queue.has(callback) || queue.add(callback),
                        callback
                      )
                    },
                    cancel: (callback) => {
                      ...
                      ;((latestFrameData = frameData),
                        isProcessing
                          ...
                          : ((isProcessing = !0),
                            ...
                            stepName &&
                              statsBuffer.value &&
                              statsBuffer.value.frameloop[stepName].push(
                                numCalls
                              ),
                            (numCalls = 0),
                            thisFrame.clear(),
                  ...
                  return step
                })(flagRunNextFrame, allowKeepAlive ? key : void 0)),
                acc
              ),
              {}
            ),
        ...
        function measureAllKeyframes() {
          if (anyNeedsMeasurement) {
            const resolversToMeasure = Array.from(toResolve).filter(
              ...
              elementsToMeasure = new Set(
                resolversToMeasure.map((resolver) => resolver.element)
              ),
              transformsToRestore = new Map()
            ;(elementsToMeasure.forEach((element) => {
              ...
              resolversToMeasure.forEach((resolver) => {
                void 0 !== resolver.suspendedScrollY &&
        ...
        class KeyframeResolver {
          ...
          readKeyframes() {
            ...
            if (null === unresolvedKeyframes[0]) {
              const currentValue = motionValue?.get(),
                finalKeyframe =
                  unresolvedKeyframes[unresolvedKeyframes.length - 1]
              if (void 0 !== currentValue) unresolvedKeyframes[0] = currentValue
              else if (element && name) {
                const valueAsRead = element.readValue(name, finalKeyframe)
                null != valueAsRead && (unresolvedKeyframes[0] = valueAsRead)
              }
              ;(void 0 === unresolvedKeyframes[0] &&
        ...
        function isNone(value) {
          return 'number' == typeof value
            ...
            : null === value ||
                'none' === value ||
                '0' === value ||
                isZeroValueString(value)
        }
        const sanitize = (v) => Math.round(1e5 * v) / 1e5,
          floatRegex = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu
        ...
        const functionRegex = /\b([a-z-]*)\(.*?\)/gu,
          ...
          int_int = { ...number, transform: Math.round },
          numberValueTypes = {
            borderWidth: px,
            borderTopWidth: px,
            borderRightWidth: px,
        ...
        class DOMKeyframesResolver extends KeyframeResolver {
          ...
          resolveNoneKeyframes() {
            ...
            noneKeyframeIndexes.length &&
              (function makeNoneKeyframesAnimatable(
                ...
                for (
                  ;
                  i < unresolvedKeyframes.length && !animatableTemplate;
          ...
          measureInitialState() {
            ...
            const measureKeyframe =
              unresolvedKeyframes[unresolvedKeyframes.length - 1]
            void 0 !== measureKeyframe &&
              element.getValue(name, measureKeyframe).jump(measureKeyframe, !1)
          }
          measureEndState() {
        ...
        class MotionValue {
            ...
            ;((this.canTrackVelocity = null),
              ...
              (this.updateAndNotify = (v) => {
                ...
                if (
                  ...
                  for (const dependent of this.dependents) dependent.dirty()
              }),
              (this.hasAnimated = !1),
          ...
          getVelocity() {
            ...
            if (
              ...
              currentTime - this.updatedAt > 30
            )
              return 0
            const delta = Math.min(this.updatedAt - this.prevUpdatedAt, 30)
        ...
        const valueTypes = [...dimensionValueTypes, color, complex],
          { schedule: microtask, cancel: cancelMicrotask } =
        ...
        var is_browser = __webpack_require__(
          '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/utils/is-browser.mjs'
        )
        ...
        function isAnimationControls(v) {
          return (
            null !== v && 'object' == typeof v && 'function' == typeof v.start
          )
        }
        ...
        class VisualElement {
            ...
            ;((this.current = instance),
              ...
              hasReducedMotionListener.current ||
                (function initPrefersReducedMotion() {
                  if (((hasReducedMotionListener.current = !0), is_browser.B))
          ...
          bindToMotionValue(key, value) {
            this.valueSubscriptions.has(key) &&
              ...
              for (const key in next) {
                ...
                if (isMotionValue(nextValue)) element.addValue(key, nextValue)
                  ...
                  if (element.hasValue(key)) {
                    ...
                    !0 === existingValue.liveStyle
                      ? existingValue.jump(nextValue)
                      : existingValue.hasAnimated ||
          ...
          removeValue(key) {
            ...
            ;(unsubscribe &&
              (unsubscribe(), this.valueSubscriptions.delete(key)),
          ...
          readValue(key, target) {
            let value =
              void 0 === this.latestValues[key] && this.current
          ...
          getBaseTarget(key) {
            ...
            return void 0 === target || isMotionValue(target)
              ? void 0 !== this.initialValues[key] &&
                void 0 === valueFromInitial
                ? void 0
                : this.baseTarget[key]
              : target
          }
        ...
        function buildHTMLStyles(state, latestValues, transformTemplate) {
          ...
          for (const key in latestValues) {
            ...
            if (transformProps.has(key)) hasTransform = !0
            else if (isCSSVariableName(key)) vars[key] = value
            else {
                ...
                ? (style.transform = (function buildTransform(
                    ...
                    for (let i = 0; i < numTransforms; i++) {
                      ...
                      if (
                        ((valueIsDefault =
                          'number' == typeof value
                            ? value === (key.startsWith('scale') ? 1 : 0)
                            : 0 === parseFloat(value)),
                        !valueIsDefault || transformTemplate)
                      ) {
                        const valueAsType = getValueAsType(
                          value,
                          numberValueTypes[key]
                        )
                        ;(valueIsDefault ||
                          ((transformIsDefault = !1),
                          (transformString += `${translateAlias[key] || key}(${valueAsType}) `)),
        ...
        function renderHTML(element, { style, vars }, styleProp, projection) {
          ...
          for (key in (projection?.applyProjectionStyles(
            elementStyle,
            styleProp
          ),
          vars))
        ...
        function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
          ...
          for (const key in style)
            (isMotionValue(style[key]) ||
              ...
              void 0 !== visualElement?.getValue(key)?.liveStyle) &&
        ...
        const camelToDash = (str) =>
          ...
          dashKeys = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
        ...
        function buildSVGAttrs(
          ...
          if ((buildHTMLStyles(state, latest, transformTemplate), isSVGTag))
            return void (
          ...
          ;(attrs.transform &&
            ((style.transform = attrs.transform), delete attrs.transform),
            (style.transform || attrs.transformOrigin) &&
        ...
        class SVGVisualElement extends DOMVisualElement {
          ...
          renderInstance(instance, renderState, styleProp, projection) {
            ...
            })(instance, renderState, 0, projection)
          }
          mount(instance) {
        ...
        var MotionConfigContext = __webpack_require__(
          '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs'
        )
        ...
        function makeLatestValues(
          ...
          isInitialAnimationBlocked =
            isInitialAnimationBlocked || !1 === initial
        ...
        const makeUseVisualState = (config) => (props, isStatic) => {
            const context = (0, react.useContext)(MotionContext),
              presenceContext = (0, react.useContext)(PresenceContext.t),
              make = () =>
                (function makeState(
            ...
            return isStatic ? make() : (0, use_constant.M)(make)
          },
          useHTMLVisualState = makeUseVisualState({
            scrapeMotionValuesFromProps,
            createRenderState: createHtmlRenderState,
          }),
          useSVGVisualState = makeUseVisualState({
            scrapeMotionValuesFromProps:
        ...
        const optimizedAppearDataAttribute =
            'data-' + camelToDash('framerAppearId'),
        ...
        function useVisualElement(
          ...
          const { visualElement: parent } = (0, react.useContext)(
            ...
            reducedMotionConfig = (0, react.useContext)(
              MotionConfigContext.Q
            ).reducedMotion,
            visualElementRef = (0, react.useRef)(null)
          ...
          const visualElement = visualElementRef.current,
            initialLayoutGroupConfig = (0, react.useContext)(
              SwitchLayoutGroupContext
            )
          !visualElement ||
            visualElement.projection ||
            !ProjectionNodeConstructor ||
            ('html' !== visualElement.type && 'svg' !== visualElement.type) ||
        ...
        function getClosestProjectingNode(visualElement) {
          if (visualElement)
            return !1 !== visualElement.options.allowProjection
              ? visualElement.projection
              : getClosestProjectingNode(visualElement.parent)
        }
        function createMotionComponent(
          ...
          function MotionDOMComponent(props, externalRef) {
            ...
            const configAndProps = {
                ...(0, react.useContext)(MotionConfigContext.Q),
                ...props,
            ...
            if (!isStatic && is_browser.B) {
              !(function useStrictMode(configAndProps, preloadedFeatures) {
                ;(0, react.useContext)(LazyContext).strict
                0
              })()
              const layoutProjection = (function getProjectionFunctionality(
                props
              ) {
          ...
          MotionDOMComponent.displayName = `motion.${'string' == typeof Component ? Component : `create(${Component.displayName ?? Component.name ?? ''})`}`
        ...
        function useLayoutId({ layoutId }) {
          const layoutGroupId = (0, react.useContext)(LayoutGroupContext.L).id
          return layoutGroupId && void 0 !== layoutId
            ? layoutGroupId + '-' + layoutId
            : layoutId
        }
        function createMotionProxy(preloadedFeatures, createVisualElement) {
          if ('undefined' == typeof Proxy) return createMotionComponent
          ...
          return new Proxy(
            (Component, options) => factory(Component, options),
            {
              get: (_target, key) =>
                'create' === key
                  ? factory
        ...
        function makeAnimationInstant(options) {
          ;((options.duration = 0), options.type)
        }
        const combineFunctions = (a, b) => (v) => b(a(v)),
          pipe = (...transformers) => transformers.reduce(combineFunctions),
          time_conversion_secondsToMilliseconds = (seconds) => 1e3 * seconds,
          millisecondsToSeconds = (milliseconds) => milliseconds / 1e3,
          activeAnimations = { layout: 0, mainThread: 0, waapi: 0 }
        ...
        function asRGBA(color) {
          ...
          var v
          if ((Boolean(type), !Boolean(type))) return !1
        ...
        const mixComplex = (origin, target) => {
          ...
          return originStats.indexes.var.length ===
                    ...
                    (function matchOrder(origin, target) {
                      ...
                      for (let i = 0; i < target.values.length; i++) {
                        const type = target.types[i],
                          ...
                          originValue = origin.values[originIndex] ?? 0
        ...
        const frameloopDriver = (update) => {
          ...
          generateLinearEasing = (easing, duration, resolution = 10) => {
            ...
            for (let i = 0; i < numPoints; i++)
              points +=
                Math.round(1e4 * easing(i / (numPoints - 1))) / 1e4 + ', '
        ...
        const springDefaults_stiffness = 100,
          springDefaults_damping = 10,
          springDefaults_mass = 1,
          springDefaults_velocity = 0,
          springDefaults_duration = 800,
          springDefaults_bounce = 0.3,
          springDefaults_visualDuration = 0.3,
          springDefaults_restSpeed = { granular: 0.01, default: 2 },
          springDefaults_restDelta = { granular: 0.005, default: 0.5 },
          springDefaults_minDuration = 0.01,
          springDefaults_maxDuration = 10,
          springDefaults_minDamping = 0.05,
          springDefaults_maxDamping = 1
        function findSpring({
          duration = springDefaults_duration,
          bounce = springDefaults_bounce,
          velocity = springDefaults_velocity,
          mass = springDefaults_mass,
        }) {
          let envelope, derivative
          time_conversion_secondsToMilliseconds(springDefaults_maxDuration)
          let dampingRatio = 1 - bounce
          ;((dampingRatio = clamp(
            springDefaults_minDamping,
            springDefaults_maxDamping,
            dampingRatio
          )),
            (duration = clamp(
              springDefaults_minDuration,
              springDefaults_maxDuration,
            ...
            dampingRatio < 1
              ? ((envelope = (undampedFreq) => {
                  ...
                  return (
                    0.001 -
                    ((exponentialDecay - velocity) /
                      calcAngularFreq(undampedFreq, dampingRatio)) *
                      Math.exp(-delta)
                  )
                }),
                (derivative = (undampedFreq) => {
                  ...
                  return (
                    ((0.001 - envelope(undampedFreq) > 0 ? -1 : 1) *
                      ((d - e) * f)) /
                    g
                  )
                }))
          ...
          if (
            ...
            return {
              ...
              damping: springDefaults_damping,
              duration,
            }
          {
        ...
        function spring(
          optionsOrVisualDuration = springDefaults_visualDuration,
          bounce = springDefaults_bounce
        ) {
          const options =
            'object' != typeof optionsOrVisualDuration
              ? {
              ...
              if (
                ...
                if (options.visualDuration) {
                  const visualDuration = options.visualDuration,
                    root = (2 * Math.PI) / (1.2 * visualDuration),
                    stiffness = root * root,
                    damping =
                      2 *
          ...
          if (
            (restSpeed ||
              (restSpeed = isGranularScale
                ? springDefaults_restSpeed.granular
                : springDefaults_restSpeed.default),
            restDelta ||
              (restDelta = isGranularScale
                ? springDefaults_restDelta.granular
                : springDefaults_restDelta.default),
            dampingRatio < 1)
          ) {
          ...
          const generator = {
            ...
            next: (t) => {
              ...
              if (isResolvedFromDuration) state.done = t >= duration
                ...
                let currentVelocity = 0 === t ? initialVelocity : 0
                dampingRatio < 1 &&
                  (currentVelocity =
                    0 === t
        ...
        spring.applyToOptions = (options) => {
          const generatorOptions = (function createGeneratorEasing(
            options,
            scale = 100,
            createGenerator
          ) {
            const generator = createGenerator({
              ...
              duration = Math.min(calcGeneratorDuration(generator), 2e4)
            return {
              type: 'keyframes',
              ease: (progress) =>
        ...
        function interpolate(
          ...
          if ((output.length, 1 === inputLength)) return () => output[0]
          if (2 === inputLength && output[0] === output[1])
            return () => output[1]
          const isZeroDeltaRange = input[0] === input[1]
          input[0] > input[inputLength - 1] &&
            ((input = [...input].reverse()), (output = [...output].reverse()))
          const mixers = (function createMixers(output, ease, customMixer) {
              const mixers = [],
                mixerFactory = customMixer || MotionGlobalConfig.mix || mix,
        ...
        function keyframes({
          ...
          const easingFunctions = ((ease) =>
              Array.isArray(ease) && 'number' != typeof ease[0])(ease)
        ...
        const isNotNull = (value) => null !== value
        function getFinalKeyframe(
          ...
          const resolvedKeyframes = keyframes.filter(isNotNull),
            index =
              speed < 0 || (repeat && 'loop' !== repeatType && repeat % 2 == 1)
                ? 0
                : resolvedKeyframes.length - 1
          return index && void 0 !== finalKeyframe
            ? finalKeyframe
        ...
        class JSAnimation extends WithPromise {
          ...
          tick(timestamp, sample = !1) {
            ...
            if (null === this.startTime) return generator.next(0)
            const {
              delay = 0,
              keyframes,
              repeat,
            ...
            const isAnimationFinished =
              null === this.holdTime &&
              ('finished' === this.state || ('running' === this.state && done))
            return (
              isAnimationFinished &&
                type !== inertia &&
          ...
          set time(newTime) {
            ;((newTime = time_conversion_secondsToMilliseconds(newTime)),
              ...
              0 === this.playbackSpeed
                ...
                : this.driver &&
                  (this.startTime =
                    this.driver.now() - newTime / this.playbackSpeed),
              this.driver?.start(!1))
          }
          get speed() {
          ...
          play() {
            ...
            ;('finished' === this.state
              ? (this.updateFinished(), (this.startTime = now))
              : null !== this.holdTime
                ? (this.startTime = now - this.holdTime)
                : this.startTime || (this.startTime = startTime ?? now),
              'finished' === this.state &&
                this.speed < 0 &&
        ...
        const supportsScrollTimeline = memo(
        ...
        function startWaapiAnimation(
          ...
          ;(Array.isArray(easing) && (keyframeOptions.easing = easing),
            statsBuffer.value && activeAnimations.waapi++)
          const options = {
            delay,
            duration,
        ...
        function isGenerator(type) {
          return 'function' == typeof type && 'applyToOptions' in type
        }
        class NativeAnimation extends WithPromise {
          constructor(options) {
            ...
            ;((this.isPseudoElement = Boolean(pseudoElement)),
              ...
              (this.options = options),
              options.type)
            const transition = (function applyGeneratorOptions({
              type,
              ...options
            }) {
              return isGenerator(type) && supportsLinearEasing()
                ? type.applyToOptions(options)
            ...
            ;((this.animation = startWaapiAnimation(
              ...
              !1 === transition.autoplay && this.animation.pause(),
          ...
          set speed(newSpeed) {
            ;(newSpeed < 0 && (this.finishedTime = null),
          ...
          attachTimeline({ timeline, observe }) {
            return (
              ...
              timeline && supportsScrollTimeline()
                ? ((this.animation.timeline = timeline), noop)
                : observe(this)
            )
          }
        }
        ...
        class NativeAnimationExtended extends NativeAnimation {
          constructor(options) {
            ;(replaceStringEasing(options),
              replaceTransitionType(options),
              super(options),
              options.startTime && (this.startTime = options.startTime),
              (this.options = options))
          }
          updateMotionValue(value) {
            ...
            if (void 0 !== value) return void motionValue.set(value)
            const sampleAnimation = new JSAnimation({
                ...options,
                autoplay: !1,
              }),
              sampleTime = time_conversion_secondsToMilliseconds(
                this.finishedTime ?? this.time
              )
            ;(motionValue.setWithVelocity(
              sampleAnimation.sample(sampleTime - 10).value,
          ...
          onKeyframesResolved(keyframes, finalKeyframe, options, sync) {
            ...
            ;((this.resolvedAt = time.now()),
              (function canAnimate(keyframes, name, type, velocity) {
                ...
                if (null === originKeyframe) return !1
                if ('display' === name || 'visibility' === name) return !0
                ...
                return (
                  ...
                  ((function hasKeyframesChanged(keyframes) {
                    ...
                    if (1 === keyframes.length) return !0
                    for (let i = 0; i < keyframes.length; i++)
                      if (keyframes[i] !== current) return !0
                  })(keyframes) ||
                    (('spring' === type || isGenerator(type)) && velocity))
                )
              })(keyframes, name, type, velocity) ||
                ((!MotionGlobalConfig.instantAnimations && delay) ||
                  onUpdate?.(
                    getFinalKeyframe(keyframes, options, finalKeyframe)
                  ),
              ...
              animation =
                ...
                (function supportsBrowserAnimation(options) {
                  const {
                    ...
                    subject = motionValue?.owner?.current
                  if (!(subject instanceof HTMLElement)) return !1
                  ...
                  return (
                    ...
                    ('transform' !== name || !transformTemplate) &&
                    !onUpdate &&
                    !repeatDelay &&
                    'mirror' !== repeatType &&
                    0 !== damping &&
            ...
            ;(animation.finished.then(() => this.notifyFinished()).catch(noop),
              this.pendingTimeline &&
                ((this.stopTimeline = animation.attachTimeline(
                  this.pendingTimeline
                )),
        ...
        const get_final_keyframe_isNotNull = (value) => null !== value
        ...
        const animateMotionValue =
          ...
          (onComplete) => {
            ...
            if (
              ((!1 === options.type ||
                (0 === options.duration && !options.repeatDelay)) &&
                (makeAnimationInstant(options),
                0 === options.delay && (shouldSkip = !0)),
              ...
              shouldSkip && !isHandoff && void 0 !== value.get())
            ) {
              const finalKeyframe =
              ...
              if (void 0 !== finalKeyframe)
                return void frame_frame.update(() => {
          ...
          for (const key in target) {
            ...
            if (window.MotionHandoffAnimation) {
              ...
              if (appearId) {
                ...
                null !== startTime &&
                  ((valueTransition.startTime = startTime), (isHandoff = !0))
              }
            }
              ...
              visualElement.variantChildren.size
                ? (forwardDelay = 0) => {
                    ...
                    return (function animateChildren(
                      ...
                      const animations = [],
                        numChildren = visualElement.variantChildren.size,
                        maxStaggerDuration =
                          (numChildren - 1) * staggerChildren,
                        delayIsFunction = 'function' == typeof delayChildren,
                        generateStaggerDuration = delayIsFunction
                          ? (i) => delayChildren(i, numChildren)
                          : 1 === staggerDirection
                            ? (i = 0) => i * staggerChildren
                            : (i = 0) =>
                                maxStaggerDuration - i * staggerChildren
                      return (
        ...
        function getVariantContext(visualElement) {
          ...
          if (!visualElement.isControllingVariants) {
            const context =
              ...
              {}
            return (
              void 0 !== visualElement.props.initial &&
        ...
        function createAnimationState(visualElement) {
          ...
          const buildResolvedTypeValues = (type) => (acc, definition) => {
            const resolved = resolveVariant(
              visualElement,
              definition,
              'exit' === type ? visualElement.presenceContext?.custom : void 0
            )
            if (resolved) {
          ...
          function animateChanges(changedActiveType) {
            ...
            for (let i = 0; i < numAnimationTypes; i++) {
              ...
              const { prevResolvedValues = {} } = typeState,
                ...
                markToAnimate = (key) => {
                  ...
                  motionValue && (motionValue.liveStyle = !1)
                }
            ...
            if (removedKeys.size) {
              ...
              if ('boolean' != typeof props.initial) {
              ...
              ;(removedKeys.forEach((key) => {
                const fallbackTarget = visualElement.getBaseTarget(key),
                  motionValue = visualElement.getValue(key)
          ...
          return {
            animateChanges,
            setActive: function setActive(type, isActive) {
            ...
            exit: {
              Feature: class ExitAnimationFeature extends Feature {
                ...
                update() {
                  ...
                  const { isPresent, onExitComplete } =
        ...
        function calcAxisDelta(delta, source, target, origin = 0.5) {
          ;((delta.origin = origin),
            ...
            (delta.translate =
              mixNumber(target.min, target.max, delta.origin) -
              delta.originPoint),
            ((delta.scale >= 0.9999 && delta.scale <= 1.0001) ||
              isNaN(delta.scale)) &&
              (delta.scale = 1),
            ((delta.translate >= -0.01 && delta.translate <= 0.01) ||
              ...
              (this.updatePoint = () => {
                ...
                const info = getPanInfo(this.lastMoveEventInfo, this.history),
                  ...
                  isDistancePastThreshold =
                    ...
                    })(info.offset, { x: 0, y: 0 }) >= this.distanceThreshold
        ...
        function calcRelativeAxisConstraints(axis, min, max) {
          return {
            ...
            max:
              void 0 !== max ? axis.max + max - (axis.max - axis.min) : void 0,
          }
        }
        ...
        class VisualElementDragControls {
              ...
              originEvent,
              {
                ...
                onStart: (event, info) => {
                  ...
                  if (
                    ...
                    (this.openDragLock = (function setDragLock(axis) {
          ...
          stop(event, panInfo) {
            const finalEvent = event || this.latestPointerEvent,
              finalPanInfo = panInfo || this.latestPanInfo,
              isDragging = this.isDragging
            if ((this.cancel(), !isDragging || !finalPanInfo || !finalEvent))
              return
          ...
          scalePositionWithinConstraints() {
            ...
            eachAxis((axis) => {
              ...
              if (axisValue && !1 !== this.constraints) {
                ...
                boxProgress[axis] = (function calcOrigin(source, target) {
                  let origin = 0.5
        ...
        const asyncHandler = (handler) => (event, info) => {
          handler && frame_frame.postRender(() => handler(event, info))
        }
            ...
            ;(!(function addScaleCorrector(correctors) {
              for (const key in correctors)
                ((scaleCorrectors[key] = correctors[key]),
                  isCSSVariableName(key) &&
                    (scaleCorrectors[key].isCSSVariable = !0))
              ...
              projection &&
                ...
                hasTakenAnySnapshot && projection.root.didUpdate(),
        ...
        function MeasureLayout(props) {
          const [isPresent, safeToRemove] = (0, use_presence.xQ)(),
            layoutGroup = (0, react.useContext)(LayoutGroupContext.L)
        ...
        function delay(callback, timeout) {
          const start = time.now(),
            checkElapsed = ({ timestamp }) => {
              ...
              elapsed >= timeout &&
                (cancelFrame(checkElapsed), callback(elapsed - timeout))
            }
          return (
            frame_frame.setup(checkElapsed, !0),
        ...
        function removeAxisTransforms(
          ...
          !(function removeAxisDelta(
            ...
            percent.test(translate) &&
              ...
              (translate =
                mixNumber(sourceAxis.min, sourceAxis.max, translate / 100) -
                sourceAxis.min))
        ...
        function cancelTreeOptimisedTransformAnimations(projectionNode) {
          if (
            ...
            projectionNode.root === projectionNode)
          )
            return
          ...
          parent &&
            !parent.hasCheckedOptimisedAppear &&
          ...
          return class ProjectionNode {
            ...
            mount(instance) {
              ...
              ;((this.isSVG =
                ...
                !(function isSVGSVGElement(element) {
                  return isSVGElement(element) && 'svg' === element.tagName
                })(instance)),
            ...
            update() {
              ...
              if (this.animationId <= this.animationCommitId)
                return void this.nodes.forEach(clearIsLayoutDirty)
            ...
            updateScroll(phase = 'measure') {
              ...
              if (
                (this.scroll &&
                  ...
                  (needsMeasurement = !1),
                needsMeasurement && this.instance)
              ) {
            ...
            resolveTargetDelta(forceRecalculation = !1) {
              ...
              if (this.layout && (layout || layoutId)) {
                ...
                if (this.relativeTarget || this.targetDelta) {
                  ...
                  statsBuffer.value && metrics.calculatedTargetDeltas++
                }
              }
            }
              ...
              ;(!(function applyTreeDeltas(
                ...
                for (let i = 0; i < treeLength; i++) {
                  ...
                  ;(visualElement &&
                    ...
                    'contents' === visualElement.props.style.display) ||
                    (isSharedTransition &&
                      node.options.layoutScroll &&
                      node.scroll &&
                      node !== node.root &&
                ...
                ;(treeScale.x < 1.0000000000001 &&
                  treeScale.x > 0.999999999999 &&
                  (treeScale.x = 1),
                  treeScale.y < 1.0000000000001 &&
                    treeScale.y > 0.999999999999 &&
                    (treeScale.y = 1))
            ...
            applyProjectionStyles(targetStyle, styleProp) {
              ...
              if (!this.isVisible)
                return void (targetStyle.visibility = 'hidden')
              const transformTemplate = this.getTransformTemplate()
              if (this.needsReset)
                return (
                  (this.needsReset = !1),
                  ...
                  void (targetStyle.transform = transformTemplate
                    ? transformTemplate(this.latestValues, '')
                    : 'none')
                )
              const lead = this.getLead()
              ...
              let transform = (function buildProjectionTransform(
                delta,
                treeScale,
                latestTransform
              ) {
              ...
              ;((targetStyle.transformOrigin = `${100 * x.origin}% ${100 * y.origin}% 0`),
              ...
              for (const key in scaleCorrectors) {
                ...
                if (applyTo) {
                  ...
                  isCSSVariable
                    ? (this.options.visualElement.renderState.vars[key] =
                        corrected)
        ...
        function propagateDirtyNodes(node) {
          ;(statsBuffer.value && metrics.nodes++,
            node.parent &&
              (node.isProjecting() ||
        ...
        function shouldAnimatePositionOnly(animationType, snapshot, layout) {
          return (
            ...
            ('preserve-aspect' === animationType &&
              ...
              })(aspectRatio(snapshot), aspectRatio(layout), 0.2))
          )
        }
        ...
        const DocumentProjectionNode =
          ...
          HTMLProjectionNode = create_projection_node_createProjectionNode({
        ...
        function setupGesture(elementOrSelector, options) {
          const elements = (function resolveElements(
              elementOrSelector,
              scope,
              selectorCache
            ) {
          ...
          return [
            elements,
            { passive: !0, ...options, signal: gestureAbortController.signal },
            () => gestureAbortController.abort(),
          ]
        }
        function isValidHover(event) {
          return !('touch' === event.pointerType || isDragActive())
        }
        function handleHoverEvent(node, event, lifecycle) {
          const { props } = node
          node.animationState &&
            props.whileHover &&
            node.animationState.setActive('whileHover', 'Start' === lifecycle)
        ...
        var is_html_element = __webpack_require__(
        ...
        function firePointerEvent(target, type) {
          target.dispatchEvent(
            new PointerEvent('pointer' + type, { isPrimary: !0, bubbles: !0 })
          )
        }
          ...
          const [targets, eventOptions, cancelEvents] = setupGesture(
            ...
            startPress = (startEvent) => {
              ...
              const onPressEnd = onPressStart(target, startEvent),
                onPointerEnd = (endEvent, success) => {
                  ;(window.removeEventListener('pointerup', onPointerUp),
                    window.removeEventListener(
                      'pointercancel',
                      onPointerCancel
                    ),
                    isPressing.has(target) && isPressing.delete(target),
                    isValidPressEvent(endEvent) &&
                      'function' == typeof onPressEnd &&
          ...
          return (
            targets.forEach((target) => {
              ;((options.useGlobalTarget ? window : target).addEventListener(
                ...
                (0, is_html_element.s)(target) &&
                  (target.addEventListener('focus', (event) =>
                    ((focusEvent, eventOptions) => {
        ...
        function handlePressEvent(node, event, lifecycle) {
          ...
          node.animationState &&
            props.whileTap &&
            node.animationState.setActive('whileTap', 'Start' === lifecycle)
          const callback =
            props['onTap' + ('End' === lifecycle ? '' : lifecycle)]
          callback &&
            frame_frame.postRender(() =>
              callback(event, extractEventInfo(event))
            )
              ...
              focus: {
                Feature: class FocusGesture extends Feature {
                  ...
                  onFocus() {
                    ...
                    try {
                      isFocusVisible =
                        this.node.current.matches(':focus-visible')
                    } catch (e) {
                      isFocusVisible = !0
                    }
                    isFocusVisible &&
                  ...
                  mount() {
                    this.unmount = pipe(
                      ...
                      addDomEvent(this.node.current, 'blur', () =>
                        this.onBlur()
                      )
                    )
                  }
                        ...
                        const [elements, eventOptions, cancel] = setupGesture(
                          ...
                          onPointerEnter = (enterEvent) => {
                            ...
                            const { target } = enterEvent,
                              onHoverEnd = onHoverStart(target, enterEvent)
                            if ('function' != typeof onHoverEnd || !target)
                              return
                            const onPointerLeave = (leaveEvent) => {
                              isValidHover(leaveEvent) &&
    ...
    '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/utils/is-browser.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { B: () => isBrowser })
        const isBrowser = 'undefined' != typeof window
      },
    '../../node_modules/.pnpm/framer-motion@12.23.9_@emotion+is-prop-valid@1.3.1_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/framer-motion/dist/es/utils/use-constant.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { M: () => useConstant })
        var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          '../../node_modules/.pnpm/next@15.2.4_@babel+core@7.28.0_@opentelemetry+api@1.9.0_@playwright+test@1.54.1_react-d_866e0ebb5cad13c7ae73d64ed145106f/node_modules/next/dist/compiled/react/index.js'
        )
    ...
    '../../node_modules/.pnpm/motion-dom@12.23.9/node_modules/motion-dom/dist/es/utils/is-html-element.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.d(__webpack_exports__, { s: () => isHTMLElement })
        var motion_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          '../../node_modules/.pnpm/motion-utils@12.23.6/node_modules/motion-utils/dist/es/is-object.mjs'
        )
        function isHTMLElement(element) {
          return (
            (0, motion_utils__WEBPACK_IMPORTED_MODULE_0__.G)(element) &&
    ...
    '../../node_modules/.pnpm/motion-utils@12.23.6/node_modules/motion-utils/dist/es/is-object.mjs':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, { G: () => isObject })
      },
  },
])
